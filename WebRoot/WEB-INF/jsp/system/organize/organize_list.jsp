...
//            return canRename;
        ...
        //新增(顶部左上方新增按钮被点击)
        function add() {
            $("#editOrganize").kendoWindow({
                width: "550px",
                height: "600px",
                title: "新增机构",
                actions: ["Close"],
                content: '<%=basePath%>organize/goAddOrganize.do',
                modal : true,
                visible : false,
                resizable : true
        ...
        function delByzTree(treeNode) {
            swal({
                ...
                if (isConfirm === true) {
                    var url = "<%=basePath%>organize/delOrganize.do?id=" + treeNode.id + "&tm=" + new Date().getTime();
                    $.get(url, function (data) {
                        if (data.msg == "success") {
        ...
        function edit(id){
            $("#editOrganize").kendoWindow({
                ...
                title: "修改机构",
                actions: ["Close"],
                content: '<%=basePath%>organize/goEditOrganize.do?id='+id,
                modal : true,
                visible : false,
                resizable : true
            }).data("kendoWindow").center().open();
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div id="editOrganize" class="animated fadeIn"></div>
    <div class="row">
        <div class="col-sm-12">
            <!-- 上方新增、按钮视图 -->
            <c:choose>
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-content" style="padding: 10px 10px 10px 10px;">
                            <form role="form" class="form-inline"
                                  action="organize/listOrganizes.do" method="post" name="organizeForm"
                                  id="organizeForm">
            ...
            <c:choose>
            <c:when test='${not empty organizes}'>display:block;</c:when>
