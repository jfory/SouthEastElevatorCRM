				...
				<div style="padding-bottom:40px;">
					...
					<!-- 查看进来时不显示 -->
					 <c:if test="${msg !='view' }">
					  ...
					  height:31px" type="button" onclick="CNquoteInformation('${pd.AZ_OFFER_ID}','${pd.AZ_ITEM_ID}');">报价信息</button>
...
<form action="contractNewInstallation/handleAgent.do" name="handleLeaveForm" id="handelLeaveForm" method="post">
	<input type="hidden" id="task_id" name="task_id" value="${pd.task_id}">
	<input type="hidden" id="AZ_UUID" name="AZ_UUID" value="${pd.AZ_UUID}">
