...
--%>   
       ...
       <button class="btn  btn-success" title="新建" type="button" style="margin-top: 5px;margin-bottom:0px;margin-right:10px;float: right" onclick="add();">关闭</button>
       <button class="btn  btn-success" title="刷新" type="button" style="margin-top: 5px;margin-bottom:0px;margin-right:5px;float: right" onclick="refreshCurrentTab();">提交</button>
       <button class="btn  btn-success" title="新建" type="button" style="margin-top: 5px;margin-bottom:0px;margin-right:5px;float: right" onclick="add();">保存</button>
       <button class="btn  btn-success" title="刷新" type="button" style="margin-top: 5px;margin-bottom:0px;margin-right:5px;float: right" onclick="refreshCurrentTab();">附件</button>
				...
				<div class="col-sm-12">
					<div class="ibox float-e-margins">
						...
						<div class="row" >
                         ...
                         <button class="btn  btn-success" title="删除" type="button" style="margin-top: 5px;margin-bottom:0px;float: right" onclick="refreshCurrentTab();">删除</button>
								...
								<div class="panel panel-primary">
									...
									<c:choose>
										...
										<div class="form-group form-inline">
											<label style="width: 10%; margin-left: 10px;">开票主体:</label> 
											 <select class="form-control" name="money_type" id="search_money_type" data-placeholder="开票主体" style="vertical-align:top;width:20%" title="开票主体">
                                
                                    <option value="0">东南电梯</option>
                                    ...
                                    <option value="2">2</option>
												...
												style="width: 20%" type="text" name="ticket_holder"
												 id="ticket_holder"
												value="${info.ticket_holder}" title="购货单位名称"
												class="form-control" />
												<label
										...
										<div class="form-group form-inline">
											<label style="width: 10%; margin-left: 10px;">开票地址:</label> <input
												style="width: 80%" type="text" name="invoice_number"
												 id="invoice_number"
										...
										<div class="form-group form-inline">			
												...
												style="width: 80%" type="text" name="remarks"
												 id="remarks"
												value="${info.remarks}" title="备注"
												class="form-control" />
