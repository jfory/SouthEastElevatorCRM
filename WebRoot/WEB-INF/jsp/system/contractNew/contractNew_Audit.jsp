...
<body class="gray-bg">
							...
							<div id="tab-2" class="tab-pane">
								<div class="ibox float-e-margins">
									<div class="ibox-content">
										...
										<form role="form" class="form-inline" action="contractNew/ContractAudit.do" method="post" name="leaveForm2" id="leaveForm2">
														...
														<c:if test="${QX.cha == 1 }">
															<c:forEach items="${ContractList}" var="eo" varStatus="vs2">
																<tr>
																	...
																	<td style="text-align:center;">
																		<button class="btn  btn-success btn-sm" title="查看" type="button" onclick="CNselect('${eo.HT_UUID}')">查看</button>
																		<c:if test="${eo.type == '0'}">
																			<button class="btn  btn-primary btn-sm" title="签收" type="button" onclick="claimstra('${eo.task_id}');">签收</button>
																		</c:if>
																		<c:if test="${eo.type == '1'}">
																			<button class="btn  btn-warning btn-sm" title="办理" type="button" onclick="goHandlestra('${eo.task_id}','${eo.HT_UUID}');">办理</button>
																		</c:if>
																	</td>
							...
							<div id="tab-3" class="tab-pane">
								<div class="ibox float-e-margins">
									<div class="ibox-content">
										...
										<form role="form" class="form-inline" action="contractNew/listDoneOffer.do" method="post" name="leaveForm3" id="leaveForm3">
														...
														<c:if test="${QX.cha == 1 }">
															<c:forEach items="${ContractList}" var="e" varStatus="vs3">
																<tr>
																	...
																	<td style="text-align:center;">
																		<button class="btn  btn-success btn-sm" title="查看" type="button" onclick="CNselect('${e.HT_UUID}')" >查看</button>
	...
	<script type="text/javascript">
	 ...
	 //办理任务
	 function goHandlestra(task_id,HT_UUID){
		 $("#handleLeave").kendoWindow({
			 width: "100%",
			 height: "100%",
			 title: "办理任务",
			 actions: ["Close"],
			 content: '<%=basePath%>contractNew/goHandStra.do?task_id='+task_id+'&HT_UUID='+HT_UUID,
			 modal : true,
			 visible : false,
			 resizable : true
