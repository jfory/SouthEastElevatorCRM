							...
							<div id="tab-2" class="tab-pane">
								<div class="ibox float-e-margins">
									<div class="ibox-content">
										...
										<form role="form" class="form-inline" action="production/productionOneAudit.do" method="post" name="leaveForm2" id="leaveForm2">
							...
							<div id="tab-3" class="tab-pane">
								<div class="ibox float-e-margins">
									<div class="ibox-content">
										...
										<form role="form" class="form-inline" action="production/listDoneStra.do" method="post" name="leaveForm3" id="leaveForm3">
	...
	<script type="text/javascript">
		...
		function startLeave(id,process_instance_id){
		 ...
		 function claimstra(task_id){
			 swal({
				 ...
				 if (isConfirm === true) {
					 var url = "<%=basePath%>production/claim.do?task_id="+task_id+"&tm="+new Date().getTime();
					 $.get(url, function (data) {
						 console.log(data.msg);
						 if (data.msg == "success") {
							 swal({
	 ...
	 function goHandlestra(task_id,pro_no){
		 $("#handleLeave").kendoWindow({
			 ...
			 title: "办理任务",
			 actions: ["Close"],
			 content: '<%=basePath%>production/goHandStra.do?task_id='+task_id+'&pro_no='+pro_no,
			 modal : true,
			 visible : false,
			 resizable : true
	...
	//查看 详细信息 
		function viewstra(pro_no){
			$("#Viewstra").kendoWindow({
		        ...
		        title: "排产信息",
		        actions: ["Close"],
		        content: '<%=basePath%>production/toView.do?pro_no='+pro_no,
		        modal : true,
				visible : false,
				resizable : true
		    }).data("kendoWindow").center().open();
