							...
							<div id="tab-2" class="tab-pane">
								<div class="ibox float-e-margins">
									<div class="ibox-content">
										...
										<form role="form" class="form-inline" action="production/productionTowAudit.do" method="post" name="leaveForm2" id="leaveForm2">
							...
							<div id="tab-3" class="tab-pane">
								<div class="ibox float-e-margins">
									<div class="ibox-content">
										...
										<form role="form" class="form-inline" action="production/listDoneStraTow.do" method="post" name="leaveForm3" id="leaveForm3">
	...
	<script type="text/javascript">
	 ...
	 function goHandlestra(task_id,pro_no){
		 $("#handleLeave").kendoWindow({
			 ...
			 title: "办理任务",
			 actions: ["Close"],
			 content: '<%=basePath%>production/goHandStraTow.do?task_id='+task_id+'&pro_no='+pro_no,
			 modal : true,
			 visible : false,
			 resizable : true
