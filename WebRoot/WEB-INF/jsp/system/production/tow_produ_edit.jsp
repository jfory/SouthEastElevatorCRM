...
<body class="gray-bg">
	<form action="production/${msg}.do" name="cellForm" id="cellForm"
		...
		<input type="hidden" name="special_state"id="special_state" value="${pd.special_state}" />
