	                    ...
	                    <div id="top",name="top"></div>
	                        ...
	                        <div class="table-responsive" >
								...
								<div class="col-lg-12" style="padding-left:0px;padding-right:0px">
									...
									<a class="btn btn-warning" title="导出到Excel" type="button" target="_blank" href="<%=basePath%>models/toExcel.do?elevator_id=2">导出</a>
											<button class="btn btn-info" title="导入到Excel" type="button" onclick="inputFile()">导入</button>
											<input style="display: none" class="form-control" type="file"  title="导入" id="importFile" onchange="importExcel(this,2)"/>
										${page.pageStr}
								</div>
	                        </div>
	                    </div>
    ...
    <script type="text/javascript">
		...
		function add(){
			$("#AddModels").kendoWindow({
		        ...
		        title: "新增型号",
		        actions: ["Close"],
		        content: '<%=basePath%>homeModels/toHomeModelsAdd.do',
		        modal : true,
				visible : false,
				resizable : true
		...
		function edit(models_id){
			$("#EditModels").kendoWindow({
		        ...
		        title: "编辑型号",
		        actions: ["Close"],
		        content: '<%=basePath%>homeModels/toHomeModelsEdit.do?models_id='+models_id,
		        modal : true,
				visible : false,
				resizable : true
		    }).data("kendoWindow").maximize().open();
