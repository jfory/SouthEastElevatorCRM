...
<body class="gray-bg">
<form action="homeModels/${msg}.do" name="modelsForm" id="modelsForm" method="post">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body" >
                                        ...
                                        <div class="form-group form-inline">
											...
											<select style="width: 25%" class="form-control" id="elevator_speed_id" name="elevator_speed_id" onchange="countHomeStandardPrice()">
												<option value="">请选择</option>
												<option value="1" ${pd.elevator_speed_id eq 1 ? "selected":"" }>0.5-1.0</option>
											</select>
											
											<span style="color: red">*</span>
											<label style="width: 6%">电梯重量:</label>
											<select style="width: 25%" class="form-control" id="elevator_weight_id" name="elevator_weight_id" onchange="countHomeStandardPrice()">
												<option value="">请选择</option>
												<option value="1" ${pd.elevator_weight_id eq 1 ? "selected":"" }>320</option>
												<option value="2" ${pd.elevator_weight_id eq 2 ? "selected":"" }>400</option>
												<option value="3" ${pd.elevator_weight_id eq 3 ? "selected":"" }>450</option>
											</select>
                                    			
                                    		
                                        	<span style="color: red">*</span>
											<label style="width: 6%">层站门:</label>
											<select style="width: 25%" class="form-control" id="elevator_storey_id" name="elevator_storey_id" onchange="countHomeStandardPrice()">
												<option value="">请选择</option>
												<option value="1" ${pd.elevator_storey_id eq 1 ? "selected":"" }>2/2/2</option>
												<option value="2" ${pd.elevator_storey_id eq 2 ? "selected":"" }>3/3/3</option>
												<option value="3" ${pd.elevator_storey_id eq 3 ? "selected":"" }>4/4/4</option>
												<option value="4" ${pd.elevator_storey_id eq 4 ? "selected":"" }>5/5/5</option>
												<option value="5" ${pd.elevator_storey_id eq 5 ? "selected":"" }>6/6/6</option>
											</select>
                        ...
                        <c:if test="${msg eq 'homeModelsAdd'}">
...
<script type="text/javascript"
	...
	$(document).ready(function(){
		...
		//计算家用电梯标准价格
		function countHomeStandardPrice(){
			...
			$.post("homeModels/countHomeStandardPrice.do",{home_speed_id:elevator_speed_id,home_weight_id:elevator_weight_id,home_storey_id:elevator_storey_id},function(result){
				if(result.success){
