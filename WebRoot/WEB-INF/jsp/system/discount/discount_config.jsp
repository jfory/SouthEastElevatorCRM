...
<head>
    ...
    <script type="text/javascript">
        ...
        function add() {
            ...
            $("#discountConfig").kendoWindow({
                width: "550px",
                height: "600px",
                title: "新增折扣",
                actions: ["Close"],
                content: '<%=basePath%>discount/goAddDiscountConfig.do?user_id='+user_id,
                modal : true,
                visible : false,
                resizable : true
        ...
        function beforeClick(treeId, treeNode, clickFlag) {
        	...
        	if(treeNode.nodeType=="0"){
	        	$.post("<%=basePath%>discount/goSetDiscountConfig.do?id="+treeNode.id+"&type="+treeNode.nodeType,
	        			function(data){
	        				var jsonObj = data.configPd;
                            var trStr = "";
                            if(jsonObj!=null&&jsonObj!=""){
                                trStr = "<tr><td>"+jsonObj.name+"</td><td>"+jsonObj.discount+"</td><td>"+jsonObj.limit_config+"</td><td><input type='button' class='btn btn-info btn-sm' value='编辑' onclick='edit("+jsonObj.id+")'/></td></tr>";
        ...
        function edit(id){
            $("#discountConfig").kendoWindow({
                ...
                title: "设置折扣",
                actions: ["Close"],
                content: '<%=basePath%>discount/goEditDiscountConfig.do?id='+id,
                modal : true,
                visible : false,
                resizable : true
            }).data("kendoWindow").center().open();
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div id="discountConfig" class="animated fadeIn"></div>
    <div class="row">
        <div class="col-sm-12">
            <!-- 上方按钮视图 -->
            <c:choose>
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-content" style="padding: 10px 10px 10px 10px;">
                            <form role="form" class="form-inline"
                                  action="discount/treeListDiscount.do" method="post" name="quotaForm"
                                  id="configForm">
            ...
            <c:choose>
            <c:when test='${not empty discount}'>display:block;</c:when>
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-content">
                            <div class="table-responsive">
                                ...
                                <div class="col-lg-12" style="padding-left:0px;padding-right:0px" id="canAdd">
									<c:if test="${QX.add == 1 }">
