...
<body class="gray-bg">
    <div class="wrapper wrapper-content animated fadeInRight">
        <div id="AddElevatorStandard" class="animated fadeIn"></div>
	            ...
	            <div class="col-sm-12">
	                <div class="ibox float-e-margins">
	                    ...
	                    <div id="top",name="top"></div>
	                        <form role="form" class="form-inline" action="elevatorStandard/elevatorStandardList.do" method="post" name="elevatorStandardForm" id="elevatorStandardForm">
	                        ...
	                        <div class="table-responsive" >
	                            <table class="table table-striped table-bordered table-hover">
	                                ...
	                                <!-- 开始循环 -->	
									<c:choose>
										<c:when test="${not empty elevatorStandardList}">
											<c:if test="${QX.cha == 1 }">
												<c:forEach items="${elevatorStandardList}" var="var" varStatus="vs">
													<tr id="${var.autoid }">
														
														
														<td><input type="checkbox"  class="i-checks" name='ids' id='ids' value="${var.elevator_standard_id}"></td>
														...
														<td>
															${var.elevator_standard_name}
														
														</td>
														<td>
															<c:forEach items="${elevatorSpeedList }" var="elevatorSpeed">
																${elevatorSpeed.elevator_speed_id eq var.elevator_speed_id ? elevatorSpeed.elevator_speed_name:'' }
															</c:forEach>
														...
														<td>
															<c:forEach items="${elevatorStoreyList }" var="elevatorStorey">
																${elevatorStorey.elevator_storey_id eq var.elevator_storey_id ? elevatorStorey.elevator_storey_name:'' }
															</c:forEach>
														</td>
														<td>${var.elevator_standard_price }</td>
								...
								<div class="col-lg-12" style="padding-left:0px;padding-right:0px">
									...
									<a class="btn btn-warning" title="导出到Excel" type="button" target="_blank" href="<%=basePath%>elevatorStandard/toExcel.do">导出</a>
    ...
    <script type="text/javascript">
		...
		//新增
		function add(){
			$("#AddElevatorStandard").kendoWindow({
		        width: "1200px",
		        height: "700px",
		        title: "新增电梯标准价格",
		        actions: ["Close"],
		        content: '<%=basePath%>elevatorStandard/goAddElevatorStandard.do',
		        modal : true,
				visible : false,
				resizable : true
