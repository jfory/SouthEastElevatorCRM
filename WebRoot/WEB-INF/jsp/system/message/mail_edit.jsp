...
<input type="hidden" value="${editPd.id}" name="id" id="id">
                <div class="mail-box-header" style="width: 100%">
                    <div class="pull-right tooltip-demo">
                        <a href="javascript:saveEdit();" class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="top" title="存为草稿"><i class="fa fa-pencil"></i> 保存草稿</a>
                ...
                <div class="mail-box">
                        ...
                        <form class="form-horizontal" method="get">
                            <div class="form-group form-line">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <!-- <input type="text" class="form-control" value="${editPd.recv_id}" name="recv_id" id="recv_id"> -->
                                </div>
                            </div>
                            <div class="form-group form-line">
                                <label class="col-sm-2 control-label" style="text-align: left">主题：</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="title" id="title" style="width: 100%" value="${editPd.title}">
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="mail-text h-200">
                        ...
                        <div class="summernote">
                            <textarea cols="90" rows="9" name="mes_text" id="mes_text" style="margin-left:30px">${editPd.mes_text}</textarea>
                        </div>
                    ...
                    <div class="mail-body text-right tooltip-demo">
                        ...
                        <a href="javascript:saveEdit();" class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="top" title="Move to draft folder"><i class="fa fa-pencil"></i> 保存草稿</a>
                    </div>
                    <div class="clearfix"></div>
                </div>
</form>
    ...
    <script type="text/javascript">
        ...
        function sendMail(){
    		...
    		$("#mailForm").attr("action", "<%=basePath%>message/sendDraft.do");
    		$("#mailForm").submit();
    	}

    	function saveEdit(){
            $("#recv_id_selected").val($("#recv_id").val());
    		$("#mailForm").attr("action", "<%=basePath%>message/saveEdit.do");
    		$("#mailForm").submit();
    	}
    </script>
</body>
