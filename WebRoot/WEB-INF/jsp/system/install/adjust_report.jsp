...
<body class="gray-bg" >
    <form action="install/${msg}.do" name="adjustReportForm" id="adjustReportForm" method="post">
    ...
    <input type="hidden" name="saveJson" id="saveJson">
    <div class="wrapper wrapper-content">
        <div class="row">
            <div class="col-sm-12">
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div class="form-group form-inline">
                                    <label>调试人:</label>
                                    <input type="text" class="form-control" name="operater" id="operater">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <td><a class="btn btn-danger" style="width: 150px; height: 34px;float:right;" onclick="javascript:CloseSUWin('AdjustReport');">关闭</a></td>
                </tr>
            </div>
        </div>
    </div>
