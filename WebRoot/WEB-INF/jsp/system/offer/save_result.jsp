...
<body>
	<script type="text/javascript">
		...
		var countsPrice = "${countsPrice}";
		var enp = window.parent.$("#elevator_nonstandard_price").val();
		if(enp==""){
			enp = 0;
		}
		var nonstandardPrice = parseInt(enp);
		console.log(countsPrice+"/"+nonstandardPrice);
		nonstandardPrice = nonstandardPrice+parseInt(countsPrice);
		window.parent.$("#elevator_nonstandard_price").val(nonstandardPrice);
		var elevator_nonstandard_json = "${elevator_nonstandard_json}";
		window.parent.$("#"+centre_id).val(elevator_nonstandard_json);
