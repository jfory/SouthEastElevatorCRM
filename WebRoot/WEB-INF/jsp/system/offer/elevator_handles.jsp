...
<script type="text/javascript"
	...
	$(document).ready(function(){
		...
		function countsPrice(){
			...
			$("#elevatorNonstandardTable").find("tr:not(:first)").each(function(){
				count2 += parseInt($(this).find("td").eq(6).html()==''?0:$(this).find("td").eq(6).html());
				
			});	
			$("#elevator_optional_price").val(count);
			$("#elevator_nonstandard_price").val(count2);
			totalPrice();
		}
		
		function totalPrice(){
			var elevator_optional_price =  parseInt($("#elevator_optional_price").val()==''?0:$("#elevator_optional_price").val());
			var elevator_nonstandard_price =  parseInt($("#elevator_nonstandard_price").val() ==''?0:$("#elevator_nonstandard_price").val()); 
			var elevator_standard_price = parseInt($("#elevator_standard_price").val() ==''?0:$("#elevator_standard_price").val());
			var total= elevator_optional_price + elevator_standard_price + elevator_nonstandard_price;
