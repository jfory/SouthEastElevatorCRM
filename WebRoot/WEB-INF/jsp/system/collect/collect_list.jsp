	            ...
	            <div class="col-sm-12">
	                <div class="ibox float-e-margins">
	                    ...
	                    <div id="top" name="top"></div>
	                        <form role="form" class="form-inline" action="collect/collectList.do" method="post" name="CollectForm" id="CollectForm">
    ...
    <script type="text/javascript">
        ...
        function add(type){
        	$("#EditCollect").kendoWindow({
		        ...
		        title: "编辑收款",
		        actions: ["Close"],
		        content: '<%=basePath%>collect/goAddCollect.do?contract_type='+type,
		        modal : true,
				visible : false,
				resizable : true
        ...
        function sel(item_id){
        	$("#EditCollect").kendoWindow({
		        ...
		        title: "编辑",
		        actions: ["Close"],
		        content: '<%=basePath%>collect/goCollectSet.do?item_id='+item_id,
		        modal : true,
				visible : false,
				resizable : true
		    }).data("kendoWindow").maximize().open();
