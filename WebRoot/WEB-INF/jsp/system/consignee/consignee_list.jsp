...
<body class="gray-bg">
	            ...
	            <div class="col-sm-12">
	                <div class="ibox float-e-margins">
	                    ...
	                    <div id="top",name="top"></div>
	                        <form role="form" class="form-inline" action="consignee/listConsignee.do?item_id=${pd.item_id }" method="post" name="ConsigneeForm" id="ConsigneeForm">
												...
												<c:forEach items="${consigneeList}" var="var" >
													<tr>
														...
														<td>
															...
															${var.consignee_state=="2"?"发货中":""}
															${var.consignee_state=="3"?"已结束":""}
														</td>
														<td>
															...
															<div>
																<c:if test="${QX.edit == 1 }">
																	<button class="btn btn-sm btn-info btn-sm" title="查看" type="button" onclick="edit('${var.consignee_id}','${pd.item_id}',sel');">查看</button>
																</c:if>
																<c:if test="${QX.edit == 1 }">
																	<button class="btn btn-sm btn-primary btn-sm" title="编辑" type="button" onclick="edit('${var.consignee_id}','${pd.item_id}');">编辑</button>
    ...
    <script type="text/javascript">
		...
		//修改/查看
		function edit(consignee_id,item_id,flag){
			$("#EditConsignee").kendoWindow({
		        width: "1000px",
		        height: "800px",
		        title: "编辑出货单",
		        actions: ["Close"],
		        content: '<%=basePath%>consignee/goEditConsignee.do?consignee_id='+consignee_id+'&item_id='+item_id+'&flag='+flag,
		        modal : true,
				visible : false,
				resizable : true
		    }).data("kendoWindow").maximize().open();
