...
<body class="gray-bg">
    ...
    <form action="e_offer/${msg}.do" name="feishangForm" id="feishangForm" method="post">
        <input type="hidden" name="ele_type" id="ele_type" value="DT3">
                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group form-inline">
                                            ...
                                            <input type="text" style="width: 20%;" class="form-control" id="FEISHANG_SL" name="FEISHANG_SL" value="${pd.FEISHANG_SL}" readonly="readonly">
                                            <input type="hidden" class="form-control" id="DT_SL" name="DT_SL" value="${pd.FEISHANG_SL}" readonly="readonly" style="width:20%;">
                                            ...
                                            <label><input type="hidden" class="form-control" id="FEISHANG_ZK" name="FEISHANG_ZK" value="${pd.FEISHANG_ZK}" onkeyup="countZhj();"></label>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                      ...
                                                      <input type="text" style="width:100%;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px" 
                                                          name="SBJ_TEMP" id="SBJ_TEMP" readonly="readonly" value="${regelevStandardPd.PRICE*pd.FEISHANG_SL}">
                                                    </td>
                                                    <!-- 选项加价 -->
                                                    <td><input type="text" style="width:100%;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px"
                                                         name="FEISHANG_XXJJ" id="FEISHANG_XXJJ" readonly="readonly" value="${pd.FEISHANG_XXJJ}"></td>
                                                    <!-- 折前价 -->
                                                    <td><input type="text" style="width:100%;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px"
                                                         name="FEISHANG_ZQJ" id="FEISHANG_ZQJ" readonly="readonly" value="${pd.FEISHANG_ZQJ}"></td>
                                                    <!-- 非标价 -->
                                                    <td><input type="text" style="width:100%;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px"
                                                         name="FEISHANG_FBJ" id="FEISHANG_FBJ" readonly="readonly" value="${pd.FEISHANG_FBJ}">
                                                    </td>
                                                    <!-- 其他费用 -->
                                                    <td><input type="text" style="width:100%;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px;background-color:yellow;"
                                                         name="FEISHANG_QTFY" id="FEISHANG_QTFY" onkeyup="JS_SJBJ();" value="${pd.FEISHANG_QTFY}">
                                                    </td>
                                                    <!-- 佣金总额 -->
                                                    <td><input type="text" style="width:100%;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px;background-color:yellow;"
                                                         name="FEISHANG_YJZE" id="FEISHANG_YJZE" onkeyup="JS_SJBJ();" value="${pd.FEISHANG_YJZE}">
                                                    </td>
                                                    <!-- 是否超标 -->
                                                    <input type="hidden" style="width:45px;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px"
                                                         name="FEISHANG_SFCB" id="FEISHANG_SFCB" value="${pd.FEISHANG_SFCB}" readonly="readonly">
                                                    <%-- <td><input type="text" style="width:45px;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px"
                                                         name="FEISHANG_SFCB" id="FEISHANG_SFCB" value="${pd.FEISHANG_SFCB}" readonly="readonly">
                                                    </td> --%>
                                                    <!-- 折扣率 -->
                                                    <td><input type="text" style="width:100%;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px"
                                                         name="FEISHANG_ZKL" id="FEISHANG_ZKL" value="${pd.FEISHANG_ZKL}" readonly="readonly">
                                                    </td>
                                                    <!-- 草签实际单价 -->
                                                    <td><input type="text" style="width:100%;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px;background-color:yellow;"
                                                     name="FEISHANG_CQSJDJ" id="FEISHANG_CQSJDJ" onkeyup="JS_SJBJ();" value="${pd.FEISHANG_CQSJDJ}"></td>
                                                    <!-- 设备实际报价 -->
                                                    <td><input type="text" style="width:100%;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px"
                                                         name="FEISHANG_SBSJBJ" id="FEISHANG_SBSJBJ" readonly="readonly" value="${pd.FEISHANG_SBSJBJ}"></td>
                                                    <!-- 比例 -->
                                                    <input type="hidden" style="width:45px;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px"
                                                         name="FEISHANG_YJBL" id="FEISHANG_YJBL" value="${pd.FEISHANG_YJBL}" readonly="readonly">
                                                   <%--  <td><input type="text" style="width:45px;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px"
                                                         name="FEISHANG_YJBL" id="FEISHANG_YJBL" value="${pd.FEISHANG_YJBL}" readonly="readonly">
                                                    </td> --%>
                                                    <!-- 安装费 -->
                                                    <td><input type="text" style="width:100%;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px"
                                                         name="FEISHANG_AZJ" id="FEISHANG_AZJ" value="${pd.FEISHANG_AZJ}" readonly="readonly">
                                                    </td>
                                                    <!-- 运输费 -->
                                                    <td><input type="text" style="width:100%;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px"
                                                         name="FEISHANG_YSJ" id="FEISHANG_YSJ" value="${pd.FEISHANG_YSJ}" readonly="readonly">
                                                    </td>
                                                    <!-- 总报价 -->
                                                    <td><input type="text" style="width:100%;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px"
                                                         name="FEISHANG_TATOL" id="FEISHANG_TATOL" value="${pd.FEISHANG_TATOL}" readonly="readonly">
                                                    </td>
                                                </tr>
                                            </table>
                                        
                                            <input type="hidden" name="FEISHANG_ZHJ" id="FEISHANG_ZHJ" value="${pd.FEISHANG_ZHJ}">
                                            <input type="hidden"  name="FEISHANG_SBJ" id="FEISHANG_SBJ" value="${regelevStandardPd.PRICE}">
                                            <%-- <input type="hidden" name="SBJ_TEMP" id="SBJ_TEMP" value="${regelevStandardPd.PRICE}"> --%>
                                            <span id="zk_">${pd.FEISHANG_ZK}</span>
                                            <input type="hidden"  name="FEISHANG_ZHSBJ" id="FEISHANG_ZHSBJ" value="${pd.FEISHANG_ZHSBJ}">
                                            <input type="hidden" name="FEISHANG_AZF" id="FEISHANG_AZF" value="${pd.FEISHANG_AZF}"/>
                                            <input type="hidden" name="FEISHANG_YSF" id="FEISHANG_YSF" value="${pd.FEISHANG_YSF}">
                                            <input type="hidden" name="FEISHANG_SJBJ" id="FEISHANG_SJBJ" value="${pd.FEISHANG_SJBJ}">
                                                    ...
                                                    <!-- 基本参数 -->
                                                        <table class="table table-striped table-bordered table-hover"  border="1" cellspacing="0">
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td colspan="5">
                                                                ...
                                                                <input name="BASE_JDJG" type="radio" value="框架结构(圈梁)" ${pd.BASE_JDJG=='框架结构(圈梁)'?'checked':''}/>框架结构(圈梁)
                                                          ...
                                                          <tr>
                                                            <td>圈/钢梁间距</td>
                                                            <td colspan="5">
                                                                <input name="BASE_QGLJJ"  id="BASE_QGLJJ" type="text" value="${pd.BASE_QGLJJ}" style="width:120px" class="form-control"/>mm
                                                            </td>
                                                            <td>&nbsp;</td>
                                                          </tr>
                                                          <tr>
                                                            ...
                                                            <td colspan="5">
                                                                <select name="BASE_JXGG" id="BASE_JXGG" class="form-control" required="required">
                                                                    ...
                                                                    <option value="4000D-2000*3600" ${pd.BASE_JXGG=='4000D-2000*3600'?'selected':''}>4000D-2000*3600</option>
                                                                    <option value="5000D-2400*3600" ${pd.BASE_JXGG=='5000D-2400*3600'?'selected':''}>5000D-2400*3600</option>
                                                                    <option value="4000D-2400*3000" ${pd.BASE_JXGG=='4000D-2400*3000'?'selected':''} >4000D-2400*3000</option>
                                                                </select>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <p>
                                                                    1000kg:<input name="BASE_JXGD" ${pd.BASE_JXGD=='1000kg-2300mm'?'checked':''} type="radio" value="1000kg-2300mm" />2300mm
                                                                </p>
                                                                <p>
                                                                    2000~3000kg:<input name="BASE_JXGD" ${pd.BASE_JXGD=='2000~3000kg-2200mm'?'checked':''} type="radio" value="2000~3000kg-2200mm" />2200mm
                                                                </p>
                                                                <p>
                                                                    4000~5000kg:<input name="BASE_JXGD" ${pd.BASE_JXGD=='4000~5000kg-2400mm'?'checked':''} type="radio" value="4000~5000kg-2400mm" />2400mm
                                                                </p>
                                                            </td>
                                                            <td colspan="3">
                                                              	  可选:
                                                                <p>
                                                                    2000~3000kg:<input name="BASE_JXGD" ${pd.BASE_JXGD=='2000~3000kg-2300mm'?'checked':''} type="radio" value="2000~3000kg-2300mm" />2300mm
                                                                    <input name="BASE_JXGD" ${pd.BASE_JXGD=='2000~3000kg-2400mm'?'checked':''} type="radio" value="2000~3000kg-2400mm" />2400mm
                                                                </p>
                                                                <p>
                                                                    4000~5000kg:<input name="BASE_JXGD" ${pd.BASE_JXGD=='4000~5000kg-2500mm'?'checked':''} type="radio" value="4000~5000kg-2500mm" />2500mm
                                                                    <input name="BASE_JXGD" ${pd.BASE_JXGD=='4000~5000kg-2600mm'?'checked':''} type="radio" value="4000~5000kg-2600mm" />2600mm
                                                                </p>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                          </tr>
                                                          <tr>
                                                            ...
                                                            <td colspan="5">
                                                                <select name="BASE_KMCC" id="BASE_KMCC" class="form-control">
                                                                  ...
                                                                  <option value="2000mm*2100mm(3000kg)" ${pd.BASE_KMCC=='1700mm*2100mm(3000kg)'?'selected':''}>1700mm*2100mm(3000kg)</option>
                                                                  <option value="2000mm*2300mm(4000kg)" ${pd.BASE_KMCC=='2000mm*2300mm(4000kg)'?'selected':''}>2000mm*2300mm(4000kg)</option>
                                                                  <option value="2200mm*2300mm(4000kg)" ${pd.BASE_KMCC=='2200mm*2300mm(4000kg)'?'selected':''}>2200mm*2300mm(4000kg)</option>
                                                                  <option value="2200mm*2300mm(5000kg)" ${pd.BASE_KMCC=='2200mm*2300mm(5000kg)'?'selected':''}>2200mm*2300mm(5000kg)</option>
                                                                </select>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                          </tr>
                                                          <tr>
                                                            ...
                                                            <td colspan="5">
                                                                <select name="BASE_JXRKSL" id="BASE_JXRKSL" class="form-control"  onchange="editGbcs('BASE_JXRKSL');"  required="required">
                                                                  <option value="">请选择</option>
														...
														<tr>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <!-- </td> -->
                                                            <td colspan="3">
                                                                <input name="BASE_JDCZQHD" type="radio" value="250" onclick="setJdczqhdDisable('0');" ${pd.BASE_JDCZQHD=='250'?'':'checked'}/>
                                                                WT=<input name="BASE_JDCZQHD_TEXT" id="BASE_JDCZQHD_TEXT" type="text" class="form-control" style="width:100px"  value="250"/>mm
                                                            </td>
                                                            <td>&nbsp;</td>
                                                          </tr>
                                                          <tr>
                                                            <td>提升高度RISE</td>
                                                            <td colspan="2">
                                                                <font color="red">*</font><input name="BASE_TSGD" onkeyup="setJdzg();" id="BASE_TSGD" type="text" class="form-control" value="${pd.BASE_TSGD}"  placeholder="必填" required="required"/>mm</td>
                                                            <td colspan="3">
                                                            	超出:
                                                          ...
                                                          <tr>
                                                            <td>井道尺寸HW*HD</td>
                                                            <td colspan="5">
                                                                <input name="BASE_JDK" id="BASE_JDK" type="text" class="form-control" style="width:15% " value="${pd.BASE_JDK}" />mm宽×
                                                                <input name="BASE_JDS" id="BASE_JDS" type="text" class="form-control" style="width:15% " value="${pd.BASE_JDS}"/>mm深
                                                            </td>
                                                            <td>&nbsp;</td>
                                                          </tr>
                                                          <tr>
                                                            ...
                                                            <td colspan="5">
                                                                <p>
                                                                <font color="red">*</font>底坑深度:<input name="BASE_DKSD" id="BASE_DKSD" type="text" class="form-control" onkeyup="setJdzg();" value="${pd.BASE_DKSD}" placeholder="必填" required="required"/>mm
                                                                </p>
                                                                <p>
                                                                <font color="red">*</font> 顶层高度:<input name="BASE_DCGD" id="BASE_DCGD" type="text" class="form-control" onkeyup="setJdzg();" value="${pd.BASE_DCGD}" placeholder="必填" required="required"/>mm
                                                                </p>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                          </tr>
                                                          <tr>
                                                            <td>井道总高</td>
                                                            <td colspan="5">
                                                                <input name="BASE_JDZG" id="BASE_JDZG" type="text" class="form-control" value="${pd.BASE_JDZG}" readonly="readonly"/>mm
                                                            </td>
                                                            <td colspan="1"><input type="hidden" name="BASE_JDZG_TEMP" id="BASE_JDZG_TEMP" style="width:60% " class="form-control"  readonly="readonly"></td>
                                                          </tr>
                                                          <tr>
                                                            <td>基站驻停</td>
                                                            <td colspan="5">在<input type="text" name="BASE_JZZT" id="BASE_JZZT"  class="form-control" value="${pd.BASE_JZZT}">层</td>
                                                            <td>&nbsp;</td>
                                                          </tr>
                                                          <tr>
                                                            <td>楼层标记</td>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td><input class="form-control" type="text" name="BASE_DGZJ_TEMP" id="BASE_DGZJ_TEMP"  readonly="readonly">
                                                    ...
                                                    <!-- 标准功能 -->
                                                        <table class="table table-striped table-bordered table-hover"  border="1" cellspacing="0">
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td>&nbsp;</td>
                                                            <td>56</td>
                                                            <td><strong>层轿门旁路装置</strong></td>
                                                            <td>&nbsp;</td>
                                                            <td>57</td>
                                                            <td><strong>门回路自监测</strong></td>
                                                            <td>&nbsp;</td>
                                                          </tr>
                                                        </table>
                                                    <!-- 标准功能 -->
                                                    ...
                                                    <!-- 可选功能 -->
                                                        <table class="table table-striped table-bordered table-hover"  border="1" cellspacing="0">
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" name="OPT_CCTVDL_TEMP" id="OPT_CCTVDL_TEMP" class="form-control" readonly="readonly">
                                                            </td>
                                                          </tr>
                                                          <tr>
                                                            <td>8</td>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td><input type="text" name="OPT_LOPANGS_TEMP" id="OPT_LOPANGS_TEMP" class="form-control" readonly="readonly"></td>
                                                          </tr>
                                                          <tr>
	                                                            <td>18</td>
	                                                            <td>IC卡(轿内控制)</td>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td>EPO</td>
                                                            <td>
                                                                <input type="checkbox" name="OPT_GTJX_TEXT" id="OPT_GTJX_TEXT" onclick="editOpt('OPT_GTJX');editGbcs('BASE_JXRKSL_SELECT');" ${pd.OPT_GTJX=='1'?'checked':''}/>
                                                                <input type="hidden" name="OPT_GTJX" id="OPT_GTJX">
                                                            </td>
                                                            <td><input type="text" name="OPT_GTJX_TEMP" id="OPT_GTJX_TEMP" class="form-control" readonly="readonly">
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td>EPO</td>
                                                            <td>
                                                                <input type="text" name="OPT_GTCS" id="OPT_GTCS" onkeyup="editOpt('OPT_GTCS')" class="form-control" value="${pd.OPT_GTCS}" readonly="readonly"/>
                                                            </td>
                                                            <td><input type="text" name="OPT_GTCS_TEMP" id="OPT_GTCS_TEMP" class="form-control" readonly="readonly">
                                                    ...
                                                    <!-- 单组监控室对讲系统 -->
                                                        <table class="table table-striped table-bordered table-hover"  border="1" cellspacing="0">
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td>对讲的电梯台数</td>
                                                            <td>
                                                                <input name="DZJKSDJXT_DJDDTTS" id="DZJKSDJXT_DJDDTTS" type="text" style="width:50px" value="${pd.DZJKSDJXT_DJDDTTS}" />台
                                                            </td>
                                                            <td>&nbsp;</td>
                                                          </tr>
                                                          <!-- <tr>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td colspan="4">
                                                                <strong>
                                                                   			 标配五方对讲：轿厢、轿顶、底坑，控制柜，监控室；选择一对多时，
                                                                   			 10台以下项目标配为分线制多局对讲,10台以下项目总线制需非标询价
                                                                   			 ；10台以上项目标配为总线制多局对讲，多局对讲系统单个监控室主机
                                                                   			 的最大控制台数为64台
                                                                </strong>
                                                            </td>
                                                          </tr>
                                                    ...
                                                    <!-- 轿厢装潢 -->
                                                        <table class="table table-striped table-bordered table-hover"  border="1" cellspacing="0">
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td rowspan="3"><input type="text" name="JXZH_QWB_TEMP" id="JXZH_QWB_TEMP" class="form-control" readonly="readonly">
                                                            	<br>
                                                              	<font color="red">如果三侧配置不一致，请非标询价!</font></td>
                                                          </tr>
                                                          <tr>
                                                            <td>侧围壁</td>
                                                            <td>
...
<!--                                                                 <p> -->
<%--                                                                     <input name="JXZH_JDZH" type="radio" value="单顶式" ${pd.JXZH_JDZH=='单顶式'?'checked':''}/>单顶式 --%>
<!--                                                                 </p> -->
<!--                                                                 <p> -->
<!--                                                                     均分块式碳钢板喷漆结构顶 -->
<!--                                                                 </p> -->
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td><input type="text" name="JXZH_BXGDD_TEMP" id="JXZH_BXGDD_TEMP" class="form-control" readonly="readonly">
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td><input type="text" name="JXZH_BXGDB_TEMP" id="JXZH_BXGDB_TEMP" class="form-control" readonly="readonly">
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td>
                                                                <input name="JXZH_DBXH" type="radio" value="" onclick="setDbxhDisable('0');" ${pd.JXZH_DBXH.substring(0, 2)=='P-'?'checked':''}/>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <input name="JXZH_FZTAZWZ1" type="checkbox" onclick="editJxzh('JXZH_FZTXH')" value="后围壁" ${pd.JXZH_FZTAZWZ1=='后围壁'?'checked':''}/>后围壁 
                                                                <input name="JXZH_FZTAZWZ2" type="checkbox" onclick="editJxzh('JXZH_FZTXH')" value="左围壁" ${pd.JXZH_FZTAZWZ2=='左围壁'?'checked':''}/>左围壁
                                                                <input name="JXZH_FZTAZWZ3" type="checkbox" onclick="editJxzh('JXZH_FZTXH')" value="右围壁" ${pd.JXZH_FZTAZWZ3=='右围壁'?'checked':''}/>右围壁
                                                            </td>
                                                            <td>&nbsp;</td>
                                                          </tr>
                                                        </table>
                                                ...
                                                <div id="tab-6" class="tab-pane">
                                                    <!-- 厅门门套 -->
                                                        <table class="table table-striped table-bordered table-hover"  border="1" cellspacing="0">
                                                          ...
                                                          <input type="hidden" name="TMMT_FWBXGTM_TEXT" id="TMMT_FWBXGTM_TEXT" onclick="editTmmt('TMMT_FWBXGTM');" ${pd.TMMT_FWBXGTM=='1'?'checked':''}>
                                                          ...
                                                          <%--发纹不锈钢小门套--%>
                                                          <input type="hidden" name="TMMT_FWBXGXMT_TEXT" id="TMMT_FWBXGXMT_TEXT" onclick="editTmmt('TMMT_FWBXGXMT');" ${pd.TMMT_FWBXGXMT=='1'?'checked':''}>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td width="198">
                                                                <input name="DMT_SL" id="DMT_SL" type="text" style="width:80px"  value="${pd.DMT_SL}"
                                                                onkeyup="setSctmmt('2');" class="form-control" />
                                                                                                                                                                                              套
                                                            </td>
                                                            <td><input type="text" name="TMMT_DMT_TEMP" id="TMMT_DMT_TEMP" class="form-control" readonly="readonly">
                                                                <input type="hidden" name="TMMT_DMT_TEMP2" id="TMMT_DMT_TEMP2" class="form-control">
                                                            </td>
                                                          </tr>
                                                          <tr>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <!-- 合同号 -->
                                                            <input type="hidden" name="text3" type="text" style="width:20px" />

                                                            <td colspan="2">
                                                                <input name="TMMT_SCSL" id="TMMT_SCSL_1" type="text" style="width:80px" value="${pd.TMMT_SCSL}" class="form-control"/>套
                                                            </td>
                                                            <td>
                                                                <p>
                                                                    可选:
                                                                ...
                                                                <p>
                                                                    <input name="TMMT_SCTMMT" id="TMMT_SCTMMT1" type="radio" value="SUS443 发纹不锈钢" onclick="setScsbhDisable('1');$('#TMMT_SCSL_2').val('1')" ${pd.TMMT_SCTMMT=='SUS443 发纹不锈钢'?'checked':''}/>SUS443 发纹不锈钢
                                                                </p>
                                                            </td>
                                                            <!-- 合同号 -->
                                                            <input name="text3" type="hidden" style="width:20px" />
                                                            <td colspan="2">
                                                                <input name="TMMT_SCSL" id="TMMT_SCSL_2" type="text" style="width:80px" onkeyup="setSctmmt('1');" value="${pd.TMMT_SCSL}" class="form-control"/>套
                                                            </td>
                                                            <td><input type="text" name="TMMT_FWBXGTM_TEMP" id="TMMT_FWBXGTM_TEMP" class="form-control" readonly="readonly">
                                                              <input type="hidden" name="TMMT_FWBXGTM_TEMP2" id="TMMT_FWBXGTM_TEMP2" class="form-control">
                                                            </td>
                                                          </tr>
                                                          <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <input name="TMMT_FSCSL" id="TMMT_FSCSL_1" type="text" style="width:80px"  value="${pd.TMMT_FSCSL}" class="form-control"/>套
                                                            </td>
                                                            <td>
                                                                <p>
                                                                    可选: 
                                                                ...
                                                                <p>
                                                                    <input name="TMMT_FSCTMMT" id="TMMT_FSCTMMT2" type="radio" value="SUS443 发纹不锈钢" onclick="setFscsbhDisable('1');$('#TMMT_FSCSL_2').val('1')" ${pd.TMMT_FSCTMMT=='SUS443 发纹不锈钢'?'checked':''}/>SUS443 发纹不锈钢
                                                                </p>
                                                            </td>
                                                            <!-- <td>
                                                            ...
                                                            <td colspan="2">
                                                                <input name="TMMT_FSCSL" id="TMMT_FSCSL_2" type="text" style="width:80px" onkeyup="setFsctmmt('1');" value="${pd.TMMT_FSCSL}" class="form-control"/>套
                                                            </td>
                                                            <td><input type="text" name="TMMT_FWBXGXMT_TEMP" id="TMMT_FWBXGXMT_TEMP" class="form-control" readonly="readonly">
                                                              <input type="hidden" name="TMMT_FWBXGXMT_TEMP2" id="TMMT_FWBXGXMT_TEMP2" class="form-control">
                                                            </td>
                                                           ...
                                                           <tr>
                                                            ...
                                                            <td width="198">
                                                                <input name="FSC_DMT_SL" id="FSC_DMT_SL" type="text"  value="${pd.FSC_DMT_SL}"
                                                                style="width:80px"  onkeyup="setFsctmmt('2');" class="form-control" />
                                                                                                                                                                                              套
                                                            </td>
                                                            <td><input type="text" name="FSC_DMT_TEMP" id="FSC_DMT_TEMP" class="form-control" readonly="readonly">
                                                    ...
                                                    <!-- 操纵盘 -->
                                                        <table class="table table-striped table-bordered table-hover"  border="1" cellspacing="0">
                                                          ...
                                                          <tr>
                                                            <td>操纵盘型号</td>
                                                            <td>可选：嵌入式</td>
                                                            <td>标准：嵌入式<input type="hidden" name="CZP_CZPLX" id="CZP_CZPLX" value="嵌入式"></td>
                                                            <td>加价</td>
                                                          </tr>
                                                          <tr>
                                                            ...
                                                            <td>
                                                                <p>
                                                                    <input name="CZP_CZPXH" type="radio" value="JFCOP19H-C" onclick="setCzpxhDisable('1');" ${pd.CZP_CZPXH=='JFCOP19H-C'?'checked':''}/>JFCOP19H-C（标配只勾选本行，下列不必选）
                                                                </p>
                                                                <p>
                                                                    显示
                                                                    <select name="CZP_XS" id="CZP_XS_1" class="form-control">
                                                                      <option value="">请选择</option>
                                                                      <option value="LCD" ${pd.CZP_XS=='LCD'?'selected':''}>LCD</option>
                                                            ...
                                                            <td>
                                                                <p>
                                                                    <input name="CZP_CZPXH" type="radio" value="JFCOP19H-E" onclick="setCzpxhDisable('2');" ${pd.CZP_CZPXH=='JFCOP19H-E'?'checked':''}/>JFCOP19H-E（标配只勾选本行，下列不必选）
                                                                </p>
                                                                <p>
                                                                    显示
                                                    ...
                                                    <!-- 厅门信号装置 -->
                                                        <table class="table table-striped table-bordered table-hover"  border="1" cellspacing="0">
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td>
                                                                <p>
                                                                    <input name="TMXHZZ_TWZHXH" type="radio" onclick="setTwzhxhDisable('1');" value="JFCOP19H-C1" ${pd.TMXHZZ_TWZHXH=='JFCOP19H-C1'?'checked':''}/>JFCOP19H-C1（标配只勾选本行，下列不必选）
                                                                </p>
                                                                <p>
                                                                    显示
                                                            ...
                                                            <td>
                                                                <p>
                                                                    <input name="TMXHZZ_TWZHXH" type="radio" value="JFCOP19H-E1" onclick="setTwzhxhDisable('2');" ${pd.TMXHZZ_TWZHXH=='JFCOP19H-E1'?'checked':''}/>JFCOP19H-E1（标配只勾选本行，下列不必选）
                                                                </p>
                                                                <p>
                                                                    显示
                                                          ...
                                                          <tr>
                                                            <td>
                                                                <p>
                                                                    在
                                                                    <input name="TMXHZZ_ZDJC" id="TMXHZZ_ZDJC_1" type="text" style="width:80px" class="form-control" value="${pd.TMXHZZ_ZDJC}" />
                                                                    层、
                                                                    每层
                                                                    <input name="TMXHZZ_MCGS" id="TMXHZZ_MCGS_1" type="text" style="width:80px" class="form-control" value="${pd.TMXHZZ_MCGS}" />
                                                                    个
                                                                </p>
                                                                <p>
                                                                    附加说明：
                                                            ...
                                                            <td>
                                                                <p>
                                                                    在
                                                                    <input name="TMXHZZ_ZDJC" id="TMXHZZ_ZDJC_2" type="text" style="width:80px" class="form-control" value="${pd.TMXHZZ_ZDJC}"/>
                                                                    层、
                                                                    每层
                                                                    <input name="TMXHZZ_MCGS" id="TMXHZZ_MCGS_2" type="text" style="width:80px" class="form-control" value="${pd.TMXHZZ_MCGS}"/>
                                                                    个
                                                                </p>
                                                                <p>
                                                                    附加说明：
                                                                    <input name="TMXHZZ_FJSM" id="TMXHZZ_FJSM_2" type="text" class="form-control" value="${pd.TMXHZZ_FJSM}"/>
                                                                </p>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                          </tr>
                                    ...
                                    <div class="panel-body">
                                        <table class="table table-striped table-bordered table-hover" border="1" cellspacing="0">
	                                      ...
	                                      <tr>
	                                        <td>总价（元）</td>
	                                        <td >
	                                            <input type="text" name="FEISHANG_AZF_TEMP" id="FEISHANG_AZF_TEMP" class="form-control" readonly="readonly" value="${pd.FEIYUE_AZF }">
	                                        </td>
	                                        <td colspan="4"></td>
	                                      </tr>
	                                    </table> 
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-primary">
                                    ...
                                    <div class="form-group form-inline">
                                        ...
                                        运输价格(元):
                                        <input type="text" id="trans_price" name="trans_price" class="form-control" oninput="countTransPrice()" value="${pd.FEISHANG_YSJ}">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        if("${pd.view}"=="edit"){
        	//首层厅门门套
            if("${pd.TMMT_SCTMMT}" == '喷涂'){
            	setScsbhDisable('0');
            } else if("${pd.TMMT_SCTMMT}" == 'SUS443 发纹不锈钢'){
            	setScsbhDisable('1');
            } else {
            	//首层厅门门套
            	$("#TMMT_SCSBH").val("");
          	...
          	//非首层厅门门套
            if("${pd.TMMT_FSCTMMT}" == '喷涂'){
            	setFscsbhDisable('0');
            } else if("${pd.TMMT_FSCTMMT}" == 'SUS443 发纹不锈钢'){
            	setFscsbhDisable('1');
            } else {
            	//非首层厅门门套
                $("#TMMT_FSCSBH").val("");
        	...
        	$("input:radio[name=TMMT_SCTMMT][value='喷涂']").prop('checked','checked');
        	setScsbhDisable('0');

        	$("input:radio[name=TMMT_FSCTMMT][value='喷涂']").prop('checked','checked');
        	setFscsbhDisable('0');
        }
  ...
  //根据门数和站数计算贯通门数
    function Jsgtms()
    {
    	...
    	var sl_ = parseInt_DN($("#FEISHANG_SL").val());
    	if(bz_zz=='1000')
    	{
    ...
    function setScsbhDisable(flag){
        if(flag=='1'){
            ...
            //计算首层厅门门套时需要考虑大门套是否选择的问题，如果已选择了大门套，则直接算厅门的价格，如果没有选，则是厅门+门套的价格
            //另外还需要考虑标配的问题，飞尚货梯的标配是喷涂，因此喷涂都不需要减价。
  ...
  //厅外召唤型号
    ...
    function editZz(isnonUpdateQLJJ){
        ...
        if(zz_=="1000"){    //载重1000时
            ...
            //绑定开门宽度
            $("#BZ_KMKD").val("1700");
            bindSelect2AndInitDate($('#BZ_KMKD'), "1700");
          
           
        }else if(zz_=="4000"){  //载重4000时
            //修改轿厢规格
            $("#BASE_JXGG").val("4000D-2400*3000").trigger("change");
            //document.getElementById("BASE_JXGG")[7].selected=true;
            //修改轿厢高度
            /* $("input[name='BASE_JXGD'][value='2400mm']").attr("checked",true); */
        	...
        	$(".intro").hide();
            //修改开门尺寸
            $("#BASE_KMCC").val("2000mm*2300mm(4000kg)");
            
          	//绑定开门宽度
            $("#BZ_KMKD").val("2200");
            bindSelect2AndInitDate($('#BZ_KMKD'), "2200");
           
        }else if(zz_=="5000"){  //载重5000时
            //修改轿厢规格
//             $("#BASE_JXGG").val("4000D-2400*3000").trigger("change");
            //document.getElementById("BASE_JXGG")[7].selected=true;
            //修改轿厢高度
        	...
        	$(".intro").hide();
            //修改开门尺寸
            $("#BASE_KMCC").val("2200mm*2300mm(5000kg)");
  ...
  //控制方式加价 
    ...
    function setMPrice(){
        ...
        var price = parseInt_DN($("#FEISHANG_SBJ").val());
        ...
        /* if(kmkd_=="900")
        {
            ...
            $("#TMMT_FWBXGTM_TEMP2").val(980*a*sl_);
            
            //非首层门套价格
            var b=$("#TMMT_FSCSL_2").val();
            $("#TMMT_FWBXGXMT_TEMP").val(310*b*sl_);
            $("#TMMT_FWBXGXMT_TEMP2").val(310*b*sl_);
        }
        else if(kmkd_=="1500")
        {
        	//首层门套价格
            ...
            $("#TMMT_FWBXGTM_TEMP2").val(1700*a*sl_);
            
            //非首层门套价格
            var b=$("#TMMT_FSCSL_2").val();
            $("#TMMT_FWBXGXMT_TEMP").val(540*b*sl_);
            $("#TMMT_FWBXGXMT_TEMP2").val(540*b*sl_);
        }
        else if(kmkd_=="2000")
        {
        	//首层门套价格
            ...
            $("#TMMT_FWBXGTM_TEMP2").val(2200*a*sl_);
            
            //非首层门套价格
            var b=$("#TMMT_FSCSL_2").val();
            $("#TMMT_FWBXGXMT_TEMP").val(690*b*sl_);
            $("#TMMT_FWBXGXMT_TEMP2").val(690*b*sl_);
        } */
    ...
    function countZhj(){
        ...
        $("#FEISHANG_XXJJ").val(/* sbj_temp+ */sbj_count+zhj_count);
        //折前价 =基价+选项加价 
        $("#FEISHANG_ZQJ").val(sbj_count+zhj_count+sbj_temp);
        
        //运输费
        var feishang_ysf = $("#FEISHANG_YSF").val()==""?0:parseInt_DN($("#FEISHANG_YSF").val());
        $("#FEISHANG_YSF").val(feishang_ysf);
        //安装费
        var feishang_azf = $("#FEISHANG_AZF_TEMP").val()==""?0:parseInt_DN($("#FEISHANG_AZF_TEMP").val());
    ...
    function setDgzj(){
        ...
        var sl_ = $("#FEISHANG_SL").val()==""?0:parseInt_DN($("#FEISHANG_SL").val()); //台数
        if(!isNaN(dgzj_)){
            var zz_ = $("#BZ_ZZ").val();  //载重
            var c_ = parseInt_DN($("#BZ_C").val())   //层数
    ...
    function editOpt(option, isRefresh){
        ...
        if(option=="OPT_XFLD"){
            ...
            $("#OPT_CCTVDL_TEMP").val(numberFixed(price));
    ...
    function editJxzh(option, isRefresh){
        ...
        if(option=="JXZH_JM"){
            ...
            if(qwb_=="SUS 443发纹不锈钢"){
            	...
            	var cwb_pt = $("input[name='JXZH_CWB']:checked").val();
            	var hwb_pt = $("input[name='JXZH_HWB']:checked").val();
            	if(cwb_pt=="SUS 443发纹不锈钢" && hwb_pt=="SUS 443发纹不锈钢"){
            		var kmkd_ = $("#BZ_KMKD").val();  //开门宽度
                    var zz_ = $("#BZ_ZZ").val();  //载重
                    if(zz_=="1000"){
                        price = 4000*sl_;
            ...
            if(cwb_=="SUS 443发纹不锈钢"){
                ...
                var qwb_pt = $("input[name='JXZH_QWB']:checked").val();
            	var hwb_pt = $("input[name='JXZH_HWB']:checked").val();
            	if(qwb_pt=="SUS 443发纹不锈钢" && hwb_pt=="SUS 443发纹不锈钢"){
            		var kmkd_ = $("#BZ_KMKD").val();  //开门宽度
                    var zz_ = $("#BZ_ZZ").val();  //载重
                    if(zz_=="1000"){
                        price = 4000*sl_;
            ...
            if(hwb_=="SUS 443发纹不锈钢"){
            	...
            	if(qwb_pt=="SUS 443发纹不锈钢" && cwb_pt=="SUS 443发纹不锈钢"){
            		var kmkd_ = $("#BZ_KMKD").val();  //开门宽度
                    var zz_ = $("#BZ_ZZ").val();  //载重
                    if(zz_=="1000"){
                        price = 4000*sl_;
...
//         	removeAttrDisabled();
			...
			$.ajax({
			    type: 'POST',
			    url: '<%=basePath%>e_offerdt/saveFeishang.do',
    ...
    function validateIsInput(){
    	//非空验证
        if ($("#FEISHANG_QTFY").val() == "" && $("#FEISHANG_QTFY").val() == "") {
			$("#FEISHANG_QTFY").focus();
			$("#FEISHANG_QTFY").tips({
				side : 3,
				msg : "请填写其他费用!",
        ...
        if ($("#FEISHANG_YJZE").val() == "" && $("#FEISHANG_YJZE").val() == "") {
			$("#FEISHANG_YJZE").focus();
			$("#FEISHANG_YJZE").tips({
				side : 3,
				msg : "请填写佣金费用!",
        ...
        if ($("#FEISHANG_CQSJDJ").val() == "" && $("#FEISHANG_CQSJDJ").val() == "") {
			$("#FEISHANG_CQSJDJ").focus();
			$("#FEISHANG_CQSJDJ").tips({
				side : 3,
				msg : "请填写草签实际单价!",
				bg : '#AE81FF',
				time : 3
        ...
        if ($("#FEISHANG_YSJ").val() == "" && $("#FEISHANG_YSJ").val() == "") {
			$("#FEISHANG_YSJ").focus();
			$("#FEISHANG_YSJ").tips({
				side : 3,
				msg : "请录入运输价!",
  	    ...
  	    $.post("<%=basePath%>e_offer/getShuiLv",
                  ...
                  },function(result)
                  {
                      if(result.msg=="success")
                      {
                        ...
                        //草签实际单价
                    	var cqsjdj=$("#FEISHANG_CQSJDJ").val();
                    	//数量
                    	var sl=$("#FEISHANG_SL").val();
                    	//赋值给设备实际报价
                    	$("#FEISHANG_SBSJBJ").val(cqsjdj*sl);
                    	
                    	//计算折扣并赋值
                    	var zkl;
                    	var qtfy=$("#FEISHANG_QTFY").val()*ShuiLv;//其他费用
                    	var yjze=$("#FEISHANG_YJZE").val()*ShuiLv;//佣金总额
                    	var sjbj=$("#FEISHANG_SBSJBJ").val();//设备实际报价
                    	var fbj=$("#FEISHANG_FBJ").val();//非标价
                    	var jj=parseInt_DN($("#SBJ_TEMP").val());//基价
                    	var xxjj=parseInt_DN($("#FEISHANG_XXJJ").val());//选项加价
                    	var qtfya=getValueToFloat("#XS_QTFY");
                    	var a=sjbj-fbj-qtfy-yjze;
                    	var b=jj+xxjj;
                    	zkl=(a/b).toFixed(3);
                    	$("#FEISHANG_ZKL").val((zkl*100).toFixed(1));
                    	
                    	//计算佣金比例并赋值
                    	var yjbl;
                    	/* var c=sjbj-fbj-qtfy;
                    	yjbl=(c/b).toFixed(3);
                    	$("#FEISHANG_YJBL").val((yjbl*100).toFixed(1)); */
                    	yjbl=$("#FEISHANG_YJZE").val()/(sjbj/ShuiLv);
                    	$("#FEISHANG_YJBL").val((yjbl*100).toFixed(1));
  ...
  //计算总报价
    ...
    {
    	//计算总报价
    	var sbsjzj_=parseInt_DN($("#FEISHANG_SBSJBJ").val());//设备实际总价
    	var qtfy_=parseInt_DN($("#FEISHANG_QTFY").val());//其他费用
    	var azf_=parseInt_DN($("#FEISHANG_AZJ").val());//安装费
    	var ysf_=parseInt_DN($("#FEISHANG_YSJ").val());//运输费
    	if(isNaN(ysf_))
    	{
    		ysf_=0;
    	}
    	...
    	$("#FEISHANG_TATOL").val(sbsjzj_+qtfy_+azf_+ysf_);
    }
    //验证表单输入数字
  	function checkForm(){
    	var checkCq=parseInt_DN($("#FEISHANG_CQSJDJ").val());//草签实际单价
    	var checkQtfy=parseInt_DN($("#FEISHANG_QTFY").val());//其他费用
    	var checkYjze=parseInt_DN($("#FEISHANG_YJZE").val());//佣金总额

    	if(isNaN(checkCq))
    	{
    		document.getElementById('FEISHANG_CQSJDJ').value='';
    	}
    	if(isNaN(checkQtfy))
    	{
    		document.getElementById('FEISHANG_QTFY').value='';
    	}
    	if(isNaN(checkYjze))
    	{
    		document.getElementById('FEISHANG_YJZE').value='';
    	} 
    }
