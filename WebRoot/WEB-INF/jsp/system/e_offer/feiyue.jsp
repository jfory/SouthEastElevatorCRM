...
<form action="e_offer/${msg}.do" name="feiyueForm" id="feiyueForm" method="post">
    <input type="hidden" name="ele_type" id="ele_type" value="DT7">
            ...
            <div class="col-sm-12">
                <div class="">
                    <div class="">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group form-inline">
                                            ...
                                            <select style="width: 20%;" class="form-control" id="BZ_ZZ" name="BZ_ZZ"
                                                ...
                                                <option value="1150" ${regelevStandardPd.ZZ=='1150'?'selected':''}>
                                                    1150
                                                </option>
                                            </select>
                                        ...
                                        <div class="form-group form-inline">
                                            ...
                                            <select style="width: 20%;" class="form-control" id="BZ_KMKD" name="BZ_KMKD"
                                                ...
                                                <option value="">请选择</option>
                                                <option value="800" ${regelevStandardPd.KMXS=='800'?'selected':''}>800
                                                </option>
                                                <option value="900" ${regelevStandardPd.KMXS=='900'?'selected':''}>900
                                                </option>
                                                <option value="1000" ${regelevStandardPd.KMXS=='1000'?'selected':''}>
                                                    1000
                                                </option>
                                                <option value="1100" ${regelevStandardPd.KMXS=='1100'?'selected':''}>
                                                    1100
                                                </option>
                                                <option value="1200" ${regelevStandardPd.KMXS=='1200'?'selected':''}>
                                                    1200
                                                </option>
                                            </select>
                                            ...
                                            <select class="form-control" style="width:7%" name="BZ_M" id="BZ_M"
                                                    onchange="setMPrice();SetCZP();$('#ELE_M').html(this.value)">
                                                <option value="">请选择</option>
                                            </select>
                                            </c:if>
                                        ...
                                        <div class="form-group form-inline">
                                            ...
                                            <input type="text" class="form-control" id="FEIYUE_SL" name="FEIYUE_SL"
                                                   value="${pd.FEIYUE_SL}" readonly="readonly" style="width:20%;">
                                            ...
                                            <input type="hidden" style="width: 11%" class="form-control" id="FEIYUE_ZK"
                                                   name="FEIYUE_ZK" value="${pd.FEIYUE_ZK}">
                                        ...
                                        <div class="form-group form-inline">
                                            ...
                                            <input type="text" style="width: 20%;" class="form-control" name="YJSYZKL"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="text"
                                                               ...
                                                               value="${regelevStandardPd.PRICE*pd.FEIYUE_SL}">
                                                    </td>
                                                    <!-- 选项加价 -->
                                                    <td><input type="text"
                                                               style="width:100%;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px"
                                                    ...
                                                    <input type="hidden" name="FEIYUE_ZHJ" id="FEIYUE_ZHJ"
                                                           value="${pd.FEIYUE_ZHJ}">
                                                    <input type="hidden" name="FEIYUE_SBJ" id="FEIYUE_SBJ"
                                                           value="${regelevStandardPd.PRICE}">
                                                    <%-- <input type="hidden" name="SBJ_TEMP" id="SBJ_TEMP" value="${regelevStandardPd.PRICE}"> --%>
                                                    <span id="zk_">${pd.FEIYUE_ZK}</span>
                                                    <input type="hidden" name="FEIYUE_ZHSBJ" id="FEIYUE_ZHSBJ"
                                                           value="${pd.FEIYUE_ZHSBJ}">
                                                    <input type="hidden" name="FEIYUE_AZF" id="FEIYUE_AZF"
                                                           value="${pd.FEIYUE_AZF}"/>
                                                    <input type="hidden" name="FEIYUE_YSF" id="FEIYUE_YSF"
                                                           value="${pd.FEIYUE_YSF}">
                                                    <input type="hidden" name="FEIYUE_SJBJ" id="FEIYUE_SJBJ"
                                                           value="${pd.FEIYUE_SJBJ}">
                                                </tr>
                                            </table>
                                        </div>
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <br><br>
                                                                <label class="intro" style="color: red;display: none;"
                                                                       id="CGJJ_Label">请非标询价</label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>井道尺寸HW*HD</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <p>
                                                                    <font color="red">*</font>底坑深度:<input
                                                                        name="BASE_DKSD" id="BASE_DKSD" type="text"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <input name="BASE_DGZJ" id="BASE_DGZJ" type="text"
                                                                       class="form-control" onkeyup="setDgzj();"
                                                                       value="${pd.BASE_DGZJ}"/>
                                                            </td>
                                                            <td>
                                                                <input type="text" style="display: inline;"
                                                                       name="BASE_DGZJ_TEMP" id="BASE_DGZJ_TEMP"
                                                                       class="form-control" readonly="readonly">
                                                                <label class="intro"
                                                                       style="color: red;display: none;width: 50%;"
                                                                       id="DGZJ_Label">请非标询价</label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <!-- 基本参数 -->
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" name="OPT_GTMS" id="OPT_GTMS"
                                                                       class="form-control" value="${pd.OPT_GTMS}"
                                                                       readonly="readonly">
                                                            </td>
                                                            <td>
                                                ...
                                                <div id="tab-5" class="tab-pane">
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                ...
                                                                <input name="JXZH_DBXH" type="radio" value="大理石预留"
                                                                       onclick="setDbxhDisable('0');" ${pd.JXZH_DBXH=='大理石预留'?'checked':''}/>
                                                                大理石预留
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2"><input type="text" name="JXZH_DBZXHD"
                                                                                   id="JXZH_DBZXHD"
                                                                                   class="form-control"
                                                                                   value="${pd.JXZH_DBZXHD}">
                                                            </td>
                                                            <td></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td colspan="2">备注</td>
                                                            <td colspan="2">
                                                                当客户自主装修或选择大理石预留时必须填写预留装潢重量,当载重为450-1000/1150-1600/2000kg时,最大允许装潢重量分别为200/300/400kg,如装潢重量超出最大允许装潢重量时,需非标处理.
                                                            </td>
                                                            <td><label class="intro" style="color: red;display: none;"
                                                                       id="JXZH_YLDB_Label">请非标询价</label></td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                ...
                                                                无<input name="JXZH_FSXH" type="radio" value=""
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <select name='TMMT_SCMK' id="TMMT_SCMK"
                                                                        onchange="editTmmt('TMMT_SCMK');"class="form-control">
                                                                    <option value="">请选择</option>
                                                        ...
                                                        <tr>
                                                            <td colspan="4" class="intro"
                                                                style="color: red;display: none;" id="TMMT_Label"><label
                                                                    style="font-size: 16px;">由于开门宽度非标,厅门门套模块请非标询价</label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <!-- 厅门门套 -->
                                                ...
                                                <div id="tab-7" class="tab-pane">
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover"
                                                        ...
                                                        <tr>
                                                            <td>操纵盘型号</td>
                                                            <td>
                                                                <select name="CZP_CZPXH" id="CZP_CZPXH" onchange="SetCZP()"
                                                                        class="form-control">
                                                                    <option value="">请选择</option>
                                    ...
                                    <div class="panel-body">
                                        <table class="table table-striped table-bordered table-hover" border="1"
                                            ...
                                            <tr>
                                                <td>总价（元）</td>
                                                <td>
                                                    <input type="text" name="FEIYUE_AZF_TEMP" id="FEIYUE_AZF_TEMP"
                                                           class="form-control" readonly="readonly"
                                                           value="${pd.FEIYUE_AZF }">
                                                </td>
                                                <td colspan="4"></td>
                        ...
                        <!--                             <div class="row" id ="FBTSDIV"> -->
                        <!--                             	<div class="col-sm-12"> -->
                        <!--                                 	<div class="panel panel-primary"> -->
                        <!--                                     	<div class="panel-heading"> -->
                        <!--                                        		 <font color="red" id="FEIBIAOTISHI" style="font-size: 14px;font-weight: bold;">非标提示</font> -->
                        <!--                                     	</div> -->
                        <!--                                     	<div class="panel-body"> -->
                        <!-- 	                                        <div class="form-group form-inline"> -->
                        <%-- 	                                        	<c:if test="${#forwardMsg!='view'}"> --%>
...
<script type="text/javascript">
    ...
    function setSbj() {
        //调用初始化贯通门
        Jsgtms();
        var sl_ = $("#FEIYUE_SL").val() == "" ? 0 : parseInt_DN($("#FEIYUE_SL").val());
    ...
    function editZz() {
        var zz_ = $("#BZ_ZZ").val();
        var kmkd_ = $("#BZ_KMKD").val();
        var danjia = parseInt_DN($("#DANJIA").val());
        if (zz_ == "630") {
...
// 		}
    ...
    function editSd() {
        ...
        if (sd_ == "1.0") {
            ...
            $("#BZ_M").append(appendStr + "<option value='15'>15</option><option value='16'>16</option><option value='17'>17</option><option value='18'>18</option><option value='19'>19</option><option value='20'>20</option><option value='21'>21</option><option value='22'>22</option><option value='23'>23</option><option value='24'>24</option><option value='25'>25</option><option value='26'>26</option><option value='27'>27</option><option value='28'>28</option><option value='29'>29</option><option value='30'>30</option>");
        } else if (sd_ == "1.75") {
    ...
    function setMPrice() {
        //调用初始化贯通门
        Jsgtms();
        var sl_ = parseInt_DN($("#FEIYUE_SL").val());
    ...
    function countZhj() {
        ...
        var bz_m_temp = parseInt_DN($("#BZ_M_TEMP").val());
        var base_kzfs_temp = parseInt_DN($("#BASE_KZFS_TEMP").val());
        ...
        var dzjksdjxt_djts_temp = parseInt_DN($("#DZJKSDJXT_DJTS_TEMP").val());
        ...
        //运输费
        var feiyue_ysf = $("#FEIYUE_YSF").val() == "" ? 0 : parseInt_DN($("#FEIYUE_YSF").val());
        $("#FEIYUE_YSF").val(feiyue_ysf);
        //安装费
        var feiyue_azf = $("#FEIYUE_AZF_TEMP").val() == "" ? 0 : parseInt_DN($("#FEIYUE_AZF_TEMP").val());
        ...
        if (!isNaN(feiyue_zk)) {
            var feiyue_sbj = parseInt_DN($("#SBJ_TEMP").val());
        ...
        $.post("<%=basePath%>e_offer/setBascPrice",
            {
                ...
                if (result.msg == "success") {
                    ...
                    if (zz_ == "630" || zz_ == "800") {
                        dgzj_std = Math.ceil((jdzg_sj / 2500) + 1);
                    } else if (zz_ == "1000" || zz_ == "1150") {
                        dgzj_std = Math.ceil((jdzg_sj / 2000) + 1);
                    }
                    var price;
                    ...
                    if (jdzg_sj == "" || isNaN(jdzg_sj)) {
                        ...
                        if (dgzj_sj > dgzj_std) {
                            ...
                            if (is_feibiao == "false") {
                                ...
                                document.getElementById("BASE_DGZJ_TEMP").style.display = "none";
                                document.getElementById("DGZJ_Label").style.display = "inline";
        ...
        if (option == "TMMT_SCMK") {
            ...
            if (scmk_ == "小门框") {
                if (scmkcz_ == "钢板喷涂") {
                    ...
                    $("#TMMT_SCMKCZ_TEMP").attr("style","black;");
                } else if (scmkcz_ == "镜面不锈钢") {
                	price = "请非标询价";
                	$("#TMMT_SCMKCZ_TEMP").attr("style","red;");
            ...
            if (qycmk_ == "小门框") {
                if (qycmkcz_ == "发纹不锈钢") {
                    ...
                    $("#TMMT_QYCMKCZ_TEMP").attr("style","black;");
                } else if (qycmkcz_ == "钢板喷涂" ||qycmkcz_ == "") {
                    price = 0;
                    $("#TMMT_QYCMKCZ_TEMP").attr("style","black;");
                }else{
                	price = "请非标询价";
                	$("#TMMT_QYCMKCZ_TEMP").attr("style","red;");
                }
            } else if (qycmk_ == "大门框") {
                if (qycmkcz_ == "发纹不锈钢") {
                    if (kmkd_ == "800") {
            ...
            if (sctmcz == "发纹不锈钢" || sctmcz == "") {
                price = 0;
                $("#TMMT_SCTMCZ_TEMP").attr("style","black;");
            }
            else if (sctmcz == "钢板喷涂") {
                if (kmkd_ == "800") {
                    price = -690 * sl_;
...
//                 }
            	price = "请非标询价";
            	$("#TMMT_SCTMCZ_TEMP").attr("style","red;");
            }

            $("#TMMT_SCTMCZ_TEMP").val(price);
        } else if (option == "TMMT_QYCTMCZ") {//其余层厅门材质
            if ($("#TMMT_QYCTMCZ").val() == "发纹不锈钢") {
                if (kmkd_ == "800") {
                    price = 690 * sl_ * (m_ - 1);
                } else if (kmkd_ == "900") {
                    price = 830 * sl_ * (m_ - 1);
                ...
                $("#TMMT_QYCTMCZ_TEMP").attr("style","black;");
            }
            else if($("#TMMT_QYCTMCZ").val() == "钢板喷涂" || $("#TMMT_QYCTMCZ").val() == ""){
                price = 0;
                $("#TMMT_QYCTMCZ_TEMP").attr("style","black;");
            }else{
            	price = "请非标询价";
            	$("#TMMT_QYCTMCZ_TEMP").attr("style","red;");
            }
...
//         	removeAttrDisabled();
			...
			$.ajax({
			    type: 'POST',
			    url: '<%=basePath%>e_offerdt/saveFeiyue.do',
			    data: $("#feiyueForm").dn2_serialize(getSelectDis())+"&saveFlag="+saveFlag,
			    dataType: "JSON",
    ...
    function saveOfAjax() {
        if (validateIsInput()) {
            ...
            $.ajax({
                ...
                data: $("#feiyueForm").dn2_serialize(getSelectDis()),
                dataType: "JSON",
                success: function (data) {
                    layer.close(index);
                    if (data.code == 1) {
...
// 	                	price = 4080+(720*djts);
    ...
    function SetCZP(){
    	...
    	var gtms_ = parseInt_DN($("#OPT_GTMS").val());
    	var czp_czpxh = $("#CZP_CZPXH").val();
    	if (czp_czpxh !="" && czp_czpxh.length >0) {
    		if (gtms_ > 0) {
    			//有贯通门
    			$("#CZP_CZPSL").val(2);		
    		}else{
