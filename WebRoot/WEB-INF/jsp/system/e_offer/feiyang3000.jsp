...
<base href="<%=basePath%>">
    ...
    <script type="text/javascript">
        ...
        var basisDate = {
        		'fbdj':null,
        		'fbDetails':{
        			'jxfbDetails':[],//轿厢非标详情[{'position':'位置','des':'描述','price':'总价'}]
        		}
        }
    </script>
</head>
...
<body class="gray-bg">
    ...
    <form action="e_offer/${msg}.do" name="feiyang3000Form" id="feiyang3000Form" method="post">
        <input type="hidden" name="ele_type" id="ele_type" value="DT4">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group form-inline">
                                            ...
                                            <select style="width: 20%;" class="form-control" id="BZ_KMXS" name="BZ_KMXS" required="required">
                                                ...
                                                <option value="中分两扇门" ${regelevStandardPd.KMXS=='中分两扇门'?'selected':''}>中分两扇门</option>
                                                <option value="旁开两扇门" ${regelevStandardPd.KMXS=='旁开两扇门'?'selected':''}>旁开两扇门</option>
                                        ...
                                        <div class="form-group form-inline">
                                            ...
                                            <select style="width: 20%;" class="form-control" id="BZ_KMXS" name="BZ_KMXS" required="required">
                                                <option value="其他" ${regelevStandardPd.KMXS=='其他'?'selected':''}>其他</option>
                                                <option value="中分两扇门" ${pd.BZ_KMXS=='中分两扇门'?'selected':''}>中分两扇门</option>
                                                <option value="旁开两扇门" ${pd.BZ_KMXS=='旁开两扇门'?'selected':''}>旁开两扇门</option>
                                                <option value="中分双折" ${regelevStandardPd.KMXS=='中分双折'?'selected':''}>中分双折</option>
                                            </select>
                                            ...
                                            <select style="width: 20%;" class="form-control" id="BZ_KMKD" name="BZ_KMKD" onchange="setMPrice();" required="required">
                                                ...
                                                <option value="1000" ${pd.BZ_KMKD=='1000'?'selected':''}>1000</option>
                                                <option value="1100" ${pd.BZ_KMKD=='1100'?'selected':''}>1100</option>
                                                <option value="1200" ${pd.BZ_KMKD=='1200'?'selected':''}>1200</option>
                                            </select>
                                            <label style="width:11%;margin-bottom: 10px">层站门:</label>
                                            <select class="form-control" style="width:7%" name="BZ_C" id="BZ_C" onchange="editC();$('#ELE_C').html(this.value);$('#BZ_Z').change();$('#BZ_M').change();">
                                                <option value="">请选择</option>
                                        ...
                                        <div class="form-group form-inline">
                                            ...
                                            <input type="text" style="width: 20%;" class="form-control" id="FEIYANG_SL" name="FEIYANG_SL" value="${pd.FEIYANG_SL}" readonly="readonly">
                                            <input type="hidden" class="form-control" id="DT_SL" name="DT_SL" value="${pd.FEIYANG_SL}" readonly="readonly" style="width:20%;">
                                           ...
                                           <!-- <label style="width:9%;margin-bottom: 10px;margin-left: 20px">折扣申请:</label> -->
                                            <input type="hidden" id="FEIYANG_ZK" name="FEIYANG_ZK" value="${pd.FEIYANG_ZK}">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                      ...
                                                      <input type="text" style="width:100%;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px" 
                                                          name="SBJ_TEMP" id="SBJ_TEMP" readonly="readonly" value="${regelevStandardPd.PRICE*pd.FEIYANG_SL}">
                                                    </td>
                                                    <!-- 选项加价 -->
                                                   ...
                                                   <%--  <td><input type="text" style="width:45px;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px"
                                                    ...
                                                    <input type="hidden" name="FEIYANG_ZHJ" id="FEIYANG_ZHJ" value="${pd.FEIYANG_ZHJ}"></td>
                                                    <input type="hidden" name="FEIYANG_SBJ" id="FEIYANG_SBJ" value="${regelevStandardPd.PRICE}">
                                                    <%-- <input type="hidden" name="SBJ_TEMP" id="SBJ_TEMP" value="${regelevStandardPd.PRICE}"> --%>
                                                    <span id="zk_">${pd.FEIYANG_ZK}</span>
                                                    <input type="hidden" name="FEIYANG_ZHSBJ" id="FEIYANG_ZHSBJ" value="${pd.FEIYANG_ZHSBJ}">
                                                    <input type="hidden" name="FEIYANG_AZF" id="FEIYANG_AZF" value="${pd.FEIYANG_AZF}"/>
                                                    <input type="hidden" name="FEIYANG_YSF" id="FEIYANG_YSF" value="${pd.FEIYANG_YSF}">
                                                    <input type="hidden" name="FEIYANG_SJBJ" id="FEIYANG_SJBJ" value="${pd.FEIYANG_SJBJ}">
                                                </tr>
                                            </table>
                                        </div>
                                                    ...
                                                    <!-- 基本参数 -->
                                                        <table class="table table-striped table-bordered table-hover" border="1" cellspacing="0">
                                                          <%-- <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <select name="BASE_KZXT" id="BASE_KZXT" class="form-control">
                                                                    <option value="">请选择</option>
                                                                    <option value="STEP" ${pd.BASE_KZXT=='STEP'?'selected':''}>STEP</option>
                                                                    <option value="Monarch" ${pd.BASE_KZXT=='Monarch'?'selected':''}>Monarch</option>
                                                                </select>
                                                            </td>
                                                            <td width="100">加价</td>
                                                          </tr> --%>
                                                          <tr>
                                                            ...
                                                            <td colspan="2">
                                                                ...
                                                                <input type="radio" name="BASE_KZFS" value="四台群控(G4C)" onclick="KZFS_TEMP('4');" ${pd.BASE_KZFS=='四台群控(G4C)'?'checked':''}/>
                                                                                                                                                                                                  四台群控(G4C) 
                                                                <input type="radio" name="BASE_KZFS" value="五台群控(G5C)" onclick="KZFS_TEMP('5');" ${pd.BASE_KZFS=='五台群控(G4C)'?'checked':''}/>
                                                                                                                                                                                                  五台群控(G5C)
                                                                <input type="radio" name="BASE_KZFS" value="六台群控(G6C)" onclick="KZFS_TEMP('6');" ${pd.BASE_KZFS=='六台群控(G4C)'?'checked':''}/>
                                                                                                                                                                                                  六台群控(G6C)                                                                                                                                                                                                                                                         
                                                            </td>
                                                          ...
                                                          <tr>
                                                            <td>号梯代码</td>
                                                            <td colspan="2">
                                                               <select name="BASE_HTDM" id="BASE_HTDM" disabled="disabled" class="form-control">
                                                                  <option value="0">请选择</option>
                                                                  <option value="A" ${pd.BASE_HTDM=='A'?'selected':''}>A</option>
                                                                  <option value="B" ${pd.BASE_HTDM=='B'?'selected':''}>B</option>
                                                                  <option value="C" ${pd.BASE_HTDM=='C'?'selected':''}>C</option>
                                                                  <option value="D" ${pd.BASE_HTDM=='D'?'selected':''}>D</option>
                                                                  <option value="E" ${pd.BASE_HTDM=='E'?'selected':''}>E</option>
                                                                  <option value="F" ${pd.BASE_HTDM=='F'?'selected':''}>F</option>
                                                                </select>                                                                                                                                                                                                                                                       
                                                            </td>
                                                            <td></td>
                                                          </tr>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <select name="BASE_JXGG" id="BASE_JXGG" class="form-control" required="required">
                                                                    <option value=''>请选择</option>
                                                                    <option value="450-1100×1100" ${pd.BASE_JXGG=='450-1100×1100'?'selected':''}>450-1100×1100</option>
                                                                    <option value="630W-1400×1100" ${pd.BASE_JXGG=='630W-1400×1100'?'selected':''}>630W-1400×1100</option>
                                                                    <option value="800W-1400×1350" ${pd.BASE_JXGG=='800W-1400×1350'?'selected':''}>800W-1400×1350</option>
                                                                    ...
                                                                    <option value="2000W-2100×1900" ${pd.BASE_JXGG=='2000W-2100×1900'?'selected':''}>2000W-2100×1900</option>
                                                                </select>   
                                                                <!-- <span class="label label-danger onPointer" onclick="showLabelDetails('jx','轿厢规格非标详情');" title="点击查看详情">非 标</span> -->
                                                           ...
                                                           <tr>
                                                            <td>轿厢材质</td>
                                                            <td colspan="2">
                                                                <select name="BASE_JXCZ" id="BASE_JXCZ" class="form-control" onchange="setJXGD()">
                                                                    <option value=''>请选择</option>
                                                                    <option value="喷涂" ${pd.BASE_JXCZ=='喷涂'?'selected':''}>喷涂</option>
                                                                    <option value="SUS304" ${pd.BASE_JXCZ=='SUS304'?'selected':''}>SUS304</option>
                                                                </select>   
                                                            </td>
                                                            <td></td>
                                                          </tr>
                                                          <tr>
                                                            <td>轿厢高度(非净高)</td>
                                                            <td colspan="2">
                                                                <select name="BASE_JXGD" id="BASE_JXGD" class="form-control" onchange="setJXGD()">
                                                                    <option value=''>请选择</option>
                                                                    <option value="2400" ${pd.BASE_JXGD=='2400'?'selected':''}>2400mm</option>
                                                                    <option value="2500" ${pd.BASE_JXGD=='2500'?'selected':''}>2500mm</option>
                                                                    <option value="2600" ${pd.BASE_JXGD=='2600'?'selected':''}>2600mm</option>
                                                                    <option value="2700" ${pd.BASE_JXGD=='2700'?'selected':''}>2700mm</option>
                                                                </select>   
                                                            </td>
                                                            <td>
                                                            	<input type="text" name="JXGD_TEMP" id="JXGD_TEMP" class="form-control" readonly="readonly">
                                                            </td>
                                                            <%-- <td>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <select name="BASE_KMCC" id="BASE_KMCC" class="form-control">
                                                                  <option value=''>请选择</option>
                                                                  <option value="700mm×2100mm(450kg)" ${pd.BASE_KMCC=='700mm×2100mm(450kg)'?'selected':''}>700mm×2100mm(450kg)</option>
                                                                  <option value="800mm×2100mm(630kg-800kg)" ${pd.BASE_KMCC=='800mm×2100mm(630kg-800kg)'?'selected':''}>800mm×2100mm(630kg-800kg)</option>
                                                                  <option value="800mm×2100mm(1000kg)" ${pd.BASE_KMCC=='800mm×2100mm(1000kg)'?'selected':''}>800mm×2100mm(1000kg)</option>
                                                                  <option value="900mm×2100mm(1000kg)" ${pd.BASE_KMCC=='900mm×2100mm(1000kg)'?'selected':''}>900mm×2100mm(1000kg)</option>
                                                                  <option value="1100mm×2100mm(1150kg-1350kg)" ${pd.BASE_KMCC=='1100mm×2100mm(1150kg-1350kg)'?'selected':''}>1100mm×2100mm(1150kg-1350kg)</option>
                                                                  <option value="1200mm×2100mm(2000kg)" ${pd.BASE_KMCC=='1200mm×2100mm(2000kg)'?'selected':''}>1200mm×2100mm(2000kg)</option>
                                                                </select>
                                                            </td>
                                                            <td></td>
                                                          </tr>
                                                          ...
                                                          <tr>
                                                            <td>井道承重墙厚度</td>
                                                            <td>
                                                                <select name="BASE_JDCZQHD" id="BASE_JDCZQHD" class="form-control">
                                                                    <option value="240" ${pd.BASE_JDCZQHD=='240'?'selected':''}>240</option>
                                                                    <option value="250" ${pd.BASE_JDCZQHD=='250'?'selected':''}>250</option>
                                                                    <option value="选项规格" ${pd.BASE_JDCZQHD=='选项规格'?'selected':''}>选项规格(大于250且小于300)</option>
                                                                </select>
                                                            </td>
                                                            <%-- <td width="317">
                                                            ...
                                                            <td width="424">
                                                                ...
                                                                WT=
                                                                <input name="BASE_JDCZQHD_TEXT" id="BASE_JDCZQHD_TEXT" type="text" class="form-control" ${pd.BASE_JDCZQHD=='250'?'':pd.BASE_JDCZQHD}/>
                                                                mm
                                                            </td> --%>
                                                            <td></td>
                                                          </tr>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td><input type="hidden" name="BASE_JDZG_TEMP" id="BASE_JDZG_TEMP" class="form-control" readonly="readonly"></td>
                                                          </tr><tr>
                                                            <td>导轨支架</td>
                                                            <td colspan="2">
                                                                <input name="BASE_DGZJ" id="BASE_DGZJ" type="text" onkeyup="setDgzj();" class="form-control" value="${pd.BASE_DGZJ}"/>
                                                            </td>
                                                    ...
                                                    <!-- 可选功能 -->
                                                        <table class="table table-striped table-bordered table-hover" border="1" cellspacing="0">
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td><input type="hidden" name="OPT_MWAN_TEMP" id="OPT_MWAN_TEMP" class="form-control" readonly="readonly"></td>
                                                            <td>15</td>
                                                            <td>厅外消防员服务</td>
                                                            <td></td>
                                                            <td>
                                                            ...
                                                            <td><input type="hidden" name="OPT_ZPC_TEMP" id="OPT_ZPC_TEMP" class="form-control" readonly="readonly"></td>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <input type="hidden" name="OPT_ICKZKSB" id="OPT_ICKZKSB"><!-- onclick="editOpt('OPT_ICKZKSB');" -->
                                                            </td>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td><input type="text" name="OPT_TDJJJY_TEMP" id="OPT_TDJJJY_TEMP" class="form-control" disabled="disabled"></td>
                                                          </tr>
                                                         <%--  <tr>
                                                    ...
                                                    <!-- 单组监控室对讲系统 -->
                                                        <table class="table table-striped table-bordered table-hover" border="1" cellspacing="0">
                                                          <tr>
                                                            ...
                                                            <td width="100">对讲电梯台数:    
                                                            <input name="DZJKSDJXT_DJTS" id="DZJKSDJXT_DJTS" type="text" onkeyup="editDzjksdjxt();" class="form-control" value="${pd.DZJKSDJXT_DJTS}"/></td>
                                                          </tr>
                                                          <tr>
                                                            <td>监控室母机配置</td>
                                                            <td>
                                                                <select name="JKSMJPZ" id="JKSMJPZ" class="form-control">
                                                                    <option value=''>请选择</option>
                                                                    <option value='一对一' ${pd.JKSMJPZ=='一对一'?'selected':''}>一对一</option>
                                                                    <option value='一对多' ${pd.JKSMJPZ=='一对多'?'selected':''}>一对多</option>
                                                                </select>
                                                            </td>
                                                            <td></td>
                                                          </tr>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td>
                                                                <select name="JXZH_JMZH" id="JXZH_JMZH" onclick="editJxzh('JXZH_JMZH');" class="form-control">
                                                                    ...
                                                                    <option value="喷涂" ${pd.JXZH_JMZH=='喷涂'?'selected':''}>钢板喷涂</option>
                                                                </select>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td>
                                                                <select name="JXZH_DBXH_SELECT" id="JXZH_DBXH_SELECT" class="form-control">
                                                                  ...
                                                                  <option value="JD-08" ${pd.JXZH_DBXH=='JD-08'?'selected':''}>JD-08</option>
                                                                </select>
                                                                <input type="hidden" id="JXZH_DBXH" name="JXZH_DBXH">
                                                            ...
                                                            <td><input type="hidden" name="JXZH_DBXH_TEMP" id="JXZH_DBXH_TEMP" class="form-control" readonly="readonly"></td>
                                                          </tr>
                                                          <tr>
                                                            <td colspan="2">地板装修厚度mm</td>
                                                            <td><%-- <input type="text" value="${pd.JXZH_DBZXHD}" name="JXZH_DBZXHD" id="JXZH_DBZXHD" class="form-control"> --%>
                                                              <select name="JXZH_DBZXHD" id="JXZH_DBZXHD" class="form-control">
                                                                  <option value="">请选择</option>
                                                                  <option value="3" ${pd.JXZH_DBZXHD=='3'?'selected':''}>3</option>
                                                                  <option value="25" ${pd.JXZH_DBZXHD=='25'?'selected':''}>25</option>
                                                                </select>
                                                            </td>
                                                            <td>如果选择25必须提供预留轿厢装潢重量</td>
                                                          </tr>
                                                          <tr>
                                                    ...
                                                    <!-- 操纵盘 -->
                                                        <table class="table table-striped table-bordered table-hover" border="1" cellspacing="0">
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td>
                                                                <p>
                                                                    <input type="radio" name="CZP_CZPXH" value="JFCOP14H-D1" onclick="setCzpxhDisable('2');" ${pd.CZP_CZPXH=='JFCOP14H-D1'?'checked':''}/>
                                                                    JFCOP14H-D1(一体式)(标配只勾选本行,下列不必选)
                                                                </p>
                                                                <p>
                                                                                                                                                                                                  显示
                                                            ...
                                                            <td>
                                                                <p>
                                                                    <input name="CZP_CZPXH" ${pd.CZP_CZPXH=='JFCOP14H-D'?'checked':''} type="radio" value="JFCOP14H-D" onclick="setCzpxhDisable('1');"/>
                                                                    JFCOP14H-D（分体式）
                                                                </p>
                                                                <p>
                                                                                                                                                                                                  显示
                                                    ...
                                                    <!-- 厅门信号装置 -->
                                                        <table class="table table-striped table-bordered table-hover" border="1" cellspacing="0">
                                                          <tr>
                                                            <td>厅外召唤类型</td>
                                                            <td>
                                                               <select name="TMXHZZ_TWZHLX" id="TMXHZZ_TWZHLX" class="form-control">
                                                                   <option value="">请选择</option>
                                                                   <option value="无底盒" ${pd.TMXHZZ_TWZHLX=='无底盒'?'selected':''}>无底盒</option>
                                                                   <option value="有底盒" ${pd.TMXHZZ_TWZHLX=='有底盒'?'selected':''}>有底盒</option>
                                                               </select></td>
                                                            <td></td>
                                                            <td></td>
                                                          </tr>
                                                          <tr>
                                                            <td>厅外召唤型号</td>
                                                            <td>
                                                               <select name="TMXHZZ_TWZHXH" id="TMXHZZ_TWZHXH" class="form-control">
                                                                   <option value="">请选择</option>
                                                                   <option value="JFHB14H-D1" ${pd.TMXHZZ_TWZHXH=='JFHB14H-D1'?'selected':''}>JFHB14H-D1</option>
                                                                   <%-- <option value="JFHB09H-D" ${pd.TMXHZZ_TWZHXH=='JFHB09H-D'?'selected':''}>JFHB09H-D</option>
                                                                   <option value="JFHB09H-C" ${pd.TMXHZZ_TWZHXH=='JFHB09H-C'?'selected':''}>JFHB09H-C</option> --%>
                                                               </select></td>
                                                            <td></td>
                                                            <td></td>
                                                          </tr>
                                                          <tr>
                                                            <td>显示</td>
                                                            <td>
                                                               <select name="TMXHZZ_XS" id="TMXHZZ_XS" class="form-control">
                                                                   <option value="">请选择</option>
                                                                   <option value="4.3寸LCD液晶屏" ${pd.TMXHZZ_XS=='4.3寸LCD液晶屏'?'selected':''}>4.3寸LCD液晶屏</option>
                                                                   <%-- <option value="LED点阵显示" ${pd.TMXHZZ_XS=='LED点阵显示'?'selected':''}>LED点阵显示</option> --%>
                                                               </select>
                                                            </td>
                                                            <td></td>
                                                            <td></td>
                                                          ...
                                                          <tr>
                                                            <td>按钮</td>
                                                            <td>
                                                               <select name="TMXHZZ_AN" id="TMXHZZ_AN" class="form-control">
                                                                   <option value="">请选择</option>
                                                                   <option value="金属白光圈A18" ${pd.TMXHZZ_AN=='金属白光圈A18'?'selected':''}>金属白光圈A18</option>
                                                               </select>
                                                            </td>
                                                            <td></td>
                                                            <td></td>
                                                          ...
                                                          <tr>
                                                            <td>材质</td>
                                                            <td>
                                                               <select name="TMXHZZ_CZ" id="TMXHZZ_CZ" class="form-control">
                                                                   <option value="">请选择</option>
                                    ...
                                    <div class="panel-body">
                                        <table class="table table-striped table-bordered table-hover" border="1" cellspacing="0">
	                                      ...
	                                      <tr>
	                                        <td>总价（元）</td>
	                                        <td >
	                                            <input type="text" name="FEIYANG_AZF_TEMP" id="FEIYANG_AZF_TEMP" class="form-control" readonly="readonly" value="${pd.FEIYUE_AZF }">
	                                        </td>
	                                        <td colspan="4"></td>
	                                      </tr>
	                                    </table> 
...
<script type="text/javascript">
    ...
    function selZhj(){
        ...
        $("#zhjView").kendoWindow({
            ...
            title: "调用参考报价",
            actions: ["Close"],
            content: "<%=basePath%>e_offer/selZhj.do?models=feiyang&BZ_ZZ="+zz_+"&BZ_SD="+sd_+"&BZ_KMXS="+kmxs_+"&BZ_KMKD="+kmkd_+"&BZ_C="+c_+"&BZ_Z="+z_+"&BZ_M="+m_+"&FEIYANG_SL="+sl_+"&FEIYANG_ZK="+zk_,
            modal : true,
            visible : false,
            resizable : true
        }).data("kendoWindow").maximize().open();
...
//     	editTmmt('TMMT_FSCTMMT');
    ...
    {
    	//判断有没有选层站门数!!!!!
    	var check = $("#TMMT_FSCTMMT1").is(":checked");
    	var sel_bz_M  = $("#BZ_M").val();
    	if (sel_bz_M>0&&!check) {
    		if(flag=='scmmt4')
        	{
    ...
    function setSbj(){
    	//调用初始化贯通门
        Jsgtms();
    	var sl_ = $("#FEIYANG_SL").val()==""?0:parseInt_DN($("#FEIYANG_SL").val());
    ...
    function editZz(isnonUpdateQLJJ){
        ...
        if(zz_=="450"){ //载重450时
            //修改轿厢规格
            /* $("#BASE_JXGG").empty();
            $("#BASE_JXGG").append("<option value='450-1100×1100'>450-1100×1100</option>"); */
            //修改开门宽度
            /* $("#BZ_KMKD").empty();
            $("#BZ_KMKD").append("<option value='800'>800</option>"); */
            //修改开门尺寸
            /* $("#BASE_KMCC").empty();
            $("#BASE_KMCC").append("<option value=''>请选择</option>"+"<option value='700mm×2100mm(450kg)'>700mm×2100mm(450kg)</option>"); */
            //修改轿厢总高
             /* $(":radio[name='BASE_JXGD'][value='2300']").prop("checked", "checked"); */
        	...
        	$("#OPT_GTMTMBF_TEMP").show();
        	$("#JXZH_BGJ_TEMP").show();
        	$("#BASE_JXGD").trigger("change");
        	
        	$(".intro").hide();
        }else if(zz_=="630"){
            //修改轿厢规格
            /* $("#BASE_JXGG").empty();
            $("#BASE_JXGG").append("<option value='630W-1400×1100'>630W-1400×1100</option>"); */
            
            //修改开门尺寸
            /* $("#BASE_KMCC").empty();
            $("#BASE_KMCC").append("<option value=''>请选择</option>"+"<option value='800mm×2100mm(630kg-800kg)'>800mm×2100mm(630kg-800kg)</option>"); */
            //修改轿厢总高
            ...
            //修改轿厢规格
            /* $("#BASE_JXGG").empty();
            $("#BASE_JXGG").append("<option value='800W-1400×1350'>800W-1400×1350</option>"); */
            
            //修改开门尺寸
           /*  $("#BASE_KMCC").empty();
            $("#BASE_KMCC").append("<option value=''>请选择</option>"+"<option value='800mm×2100mm(1000kg)'>800mm×2100mm(1000kg)</option>"); */
            //修改轿厢总高
            /*  $(":radio[name='BASE_JXGD'][value='2500']").prop("checked", "checked"); */
           ...
           /*  $("#BASE_JXGG").empty();
            ...
            //修改开门尺寸
            /* $("#BASE_KMCC").empty();
            $("#BASE_KMCC").append("<option value=''>请选择</option>"+"<option value='1100mm×2100mm(1150kg-1350kg)'>1100mm×2100mm(1150kg-1350kg)</option>"); */
            //修改轿厢总高
            /*  $(":radio[name='BASE_JXGD'][value='2500']").prop("checked", "checked"); */
        	$("#IS_FEIBIAO").val("false");
        	$("#JXZH_QWB_TEMP").show();
            ...
            //修改开门尺寸
            /* $("#BASE_KMCC").empty();
            $("#BASE_KMCC").append("<option value=''>请选择</option>"+"<option value='1100mm×2100mm(2000kg)'>1100mm×2100mm(2000kg)</option>"); */
            //修改轿厢总高
             /* $(":radio[name='BASE_JXGD'][value='2500']").prop("checked", "checked"); */
        	$("#IS_FEIBIAO").val("false");
        	$("#JXZH_QWB_TEMP").show();
            ...
            //修改轿厢规格
            /* $("#BASE_JXGG").empty();
            $("#BASE_JXGG").append("<option value='2000W-2100×1900'>2000W-2100×1900</option>"); */
            
            //修改开门尺寸
            /* $("#BASE_KMCC").empty();
            $("#BASE_KMCC").append("<option value=''>请选择</option>"+"<option value='1200mm×2100mm(2000kg)'>1200mm×2100mm(2000kg)</option>"); */
            //修改轿厢总高
             /* $(":radio[name='BASE_JXGD'][value='2500']").prop("checked", "checked"); */
        	$("#IS_FEIBIAO").val("false");
        	$("#JXZH_QWB_TEMP").show();
    ...
    function KZFS_TEMP(flag)
    {
    	...
    	{
    		price=0;
    		$("#BASE_HTDM").attr("disabled","disabled");
    		$("#BASE_HTDM").val("0");
    	}else if(flag=='2')
    	{
    		price=240*sl_;
    		$('#BASE_HTDM').removeAttr("disabled");
    	}
    	else if(flag=='3')
    	{
    		price=2400*sl_;
    ...
    function countZhj(){
       ...
       /*  var tmmt_ptjmbxgtm_temp = $("#TMMT_PTJMBXGTM_TEMP").val()==""?0:parseInt_DN($("#TMMT_PTJMBXGTM_TEMP").val()); */
        ...
        var jxgd_temp = $("#JXGD_TEMP").val()==""?0:parseInt_DN($("#JXGD_TEMP").val());
        
      	//非标选项加价
        var opt_fb_temp = $("#OPT_FB_TEMP").val()==""?0:parseInt_DN($("#OPT_FB_TEMP").val());
        
        zhj_count = fsc_dmt_temp+dzjksdjxt_djts_temp+base_ccjg+jxzh_jm_temp+jxzh_jxzh_temp+jxzh_qwb_temp+jxzh_zsdd_temp+jxzh_aqc_temp+jxzh_bgj_temp+jxzh_ylzhzl_temp+jxzh_fsazwz_temp;
        /* $("#FEIYANG_ZHJ").val(zhj_count); */

        sbj_count = jxgd_temp+opt_tdjjjy_temp+bz_m_temp+base_kzfs_temp+base_jdzg_temp+base_dgzj_temp+opt_jxdzz_temp+opt_hjzdfhjz_temp+opt_cctvdl_temp+opt_djgrbh_temp+opt_kqjhzz_temp+opt_nmykjan_temp+opt_fdlcz_temp+opt_bajk_temp+opt_nlhk_temp+opt_ick_temp+opt_ickzksb_temp+opt_ickkp_temp+opt_ptdtkt_temp+opt_zyftsdtkt_temp+opt_jkgm_temp+opt_jkyyj_temp+opt_gtmjxjmbf_temp+opt_gtmtmbf+opt_cmzh_temp+opt_jfgt_temp+opt_djt_temp+tmmt_ptdmt_temp+tmmt_sctmmt_temp+tmmt_fsctmmt_temp+czp_czpxh_temp+tmxhzz_wzycopmwan_temp+opt_fb_temp;
        //设备标准价格 (选项加价)
        ...
        //运输费
        var feiyang_ysf = $("#FEIYANG_YSF").val()==""?0:parseInt_DN($("#FEIYANG_YSF").val());
        $("#FEIYANG_YSF").val(feiyang_ysf);
        //安装费
        var feiyang_azf = $("#FEIYANG_AZF_TEMP").val()==""?0:parseInt_DN($("#FEIYANG_AZF_TEMP").val());
        $("#FEIYANG_AZF").val(feiyang_azf);

      //非标加价
        setFBPrice();
        
        
        var feiyang_zk = parseFloat($("#FEIYANG_ZK").val())/100;
        if(!isNaN(feiyang_zk)){
            var feiyang_sbj = parseInt_DN($("#SBJ_TEMP").val());
            var feiyang_sjbj = (feiyang_sbj+zhj_count+sbj_count+feiyang_azf+feiyang_ysf)*feiyang_zk;
            var feiyang_zhsbj = feiyang_sbj*feiyang_zk;
            $("#FEIYANG_SJBJ").val(feiyang_sjbj);
            $("#FEIYANG_ZHSBJ").val(feiyang_zhsbj);
            $("#zk_").text($("#FEIYANG_ZK").val()+"%");
        }
        countInstallPrice();
    }
    ...
    function editOpt(option){
        ...
        if(option=="OPT_HJZDFHJZ"){
            ...
            if($("#OPT_JKYYJ_TEXT").is(":checked")){
                var zz_ = $("#BZ_ZZ").val();
                if(zz_=="450"||zz_=="630"||zz_=="800"||zz_=="1000"||zz_=="1150"){
                    price = 12000*sl_;
    ...
    function editDzjksdjxt(){
    	...
    	if(!isNaN(djts))
    	{
            ...
            {
            	if($("input[name='DZJKSDJXT_DJTXFS']:checked").val()!="总线制"){
    ...
    function editCzp(option){
        var sl_ = parseInt_DN($("#FEIYANG_SL").val());
        var price = 0;
        if(option=="CZP_CZPXH"){
    ...
    function save(){
        ...
        if(validateIsInput()){
			...
			$.ajax({
			    type: 'POST',
			    url: '<%=basePath%>e_offerdt/saveFeiyang.do',
			    data: $("#feiyang3000Form").dn2_serialize(getSelectDis())+"&saveFlag="+saveFlag,
			    dataType: "JSON",
    ...
    function validateIsInput() {
        ...
        /* if($("#OPT_ICKKP_TEXT").val()!=null && $("#OPT_ICKKP_TEXT").val()!=""){
            $("#OPT_ICKKP").val("1");
        }else{
            $("#OPT_ICKKP").val("0");
        } */
        ...
        //轿厢装潢部分
        if($("#JXZH_DBXH").val()==""){
            $("#JXZH_DBXH").val($("#JXZH_DBXH_SELECT").val());
        }
    	...
    	if(validateIsInput()){
           var index = layer.load(1);
			$.ajax({
			    ...
			    data: $("#feiyang3000Form").dn2_serialize(getSelectDis()),
			    dataType: "JSON",
			    success: function(data) {
			    	layer.close(index);
			    	if(data.code == 1){
  ...
  //计算设备实际报价
    ...
    //验证表单输入数字
  	...
  	function setJXGD(){
  		var jxgd_ = $("#BASE_JXGD").val();
  		var jxcz_ = $("#BASE_JXCZ").val();
  		...
  		if(jxgd_ == "2700mm"){
  			if(jxcz_ == "喷涂"){
  				...
  				{
	  				case 450:
	  					$("#JXGD_TEMP").val(2800*sl_);
	  				  break;
	  				case 630:
	  					$("#JXGD_TEMP").val(2800*sl_);
	  				  break;
	  				case 800:
	  					$("#JXGD_TEMP").val(3000*sl_);
	  				  break;
	  				case 1000:
	  					$("#JXGD_TEMP").val(3000*sl_);
	  				  break;
  			...
  			}else if(jxcz_ == "SUS304"){
  				switch(zz_)
  				{
	  				case 450:
	  					$("#JXGD_TEMP").val(3200*sl_);
	  				  break;
	  				case 630:
	  					$("#JXGD_TEMP").val(3200*sl_);
	  				  break;
	  				case 800:
	  					$("#JXGD_TEMP").val(3400*sl_);
	  				  break;
	  				case 1000:
	  					$("#JXGD_TEMP").val(3400*sl_);
	  				  break;
