	            ...
	            <div class="col-sm-12">
	                <div class="ibox float-e-margins">
	                    ...
	                    <div id="top",name="top"></div>
	                        <form role="form" class="form-inline" action="escalatorModels/escalatorModelsList.do" method="post" name="modelsForm" id="modelsForm">
	                        ...
	                        <div class="table-responsive" >
								...
								<div class="col-lg-12" style="padding-left:0px;padding-right:0px">
									...
									<a class="btn btn-warning" title="导出到Excel" type="button" target="_blank" href="<%=basePath%>models/toExcel.do?elevator_id=4">导出</a>
    ...
    <script type="text/javascript">
		...
		function add(){
			$("#AddModels").kendoWindow({
		        ...
		        title: "新增型号",
		        actions: ["Close"],
		        /*content: '<%=basePath%>escalatorModels/toEscalatorModelsAdd.do',*/
		        content: '<%=basePath%>escalatorModels/toEscalatorConfigAdd.do',
		        modal : true,
				visible : false,
				resizable : true
		...
		function del(models_id,models_name){
                swal({
                        ...
                        if (isConfirm) {
                        	/*var url = "<%=basePath%>escalatorModels/modelsDelete.do?models_id="+models_id+"&guid="+new Date().getTime();*/
                        	var url = "<%=basePath%>escalatorModels/configDelete.do?models_id="+models_id+"&guid="+new Date().getTime();
		...
		function edit(models_id){
			$("#EditModels").kendoWindow({
		        ...
		        title: "编辑型号",
		        actions: ["Close"],
		        /*content: '<%=basePath%>escalatorModels/toEscalatorModelsEdit.do?models_id='+models_id,*/
		        content: '<%=basePath%>escalatorModels/toEscalatorConfigEdit.do?models_id='+models_id,
		        modal : true,
				visible : false,
				resizable : true
		    }).data("kendoWindow").maximize().open();
			...
			if(str==''){
				...
				swal({
	                ...
	                if (isConfirm) {
	                	$.ajax({
							type: "POST",
							url: '<%=basePath%>escalatorModels/modelsDeleteAll.do',
					    	data: {DATA_IDS:str},
							dataType:'json',
							cache: false,
