...
<body class="gray-bg" >
<form action="shipments/${msg}.do" name="carriageForm" id="carriageForm" method="post">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                                			...
                                			<div class="panel panel-primary">
                                    			...
                                    			<div class="panel-body">        
			                                        <div class="form-group form-inline">                                
	                                    				<label style="width:10%;margin-top: 25px;margin-bottom: 10px"><span><font color="red">*</font></span>承运单编号:</label>
				                                        <input style="width:22%" placeholder="这里输入承运单编号"  type="text" name="carriage_no" id="carriage_no" value="${pd.carriage_no }"  title="承运单编号" class="form-control" >
				                                        
				                                        <label style="width:10%;margin-top: 25px;margin-bottom: 10px"><span><font color="red">*</font></span>承运单姓名:</label>
				                                        <input style="width:22%" placeholder="这里输入承运单姓名"  type="text" name="carriage_name" id="carriage_name" value="${pd.carriage_name }"  title="承运单姓名" class="form-control" >
                        ...
                        <c:if test="${msg eq 'addCarriage'}">
                            <td><a class="btn btn-danger" style="width: 150px; height: 34px;float:right;" onclick="javascript:CloseSUWin('AddCarriage');">关闭</a></td>
                        </c:if>
                        <c:if test="${msg eq 'editCarriage'}">
                            <td><a class="btn btn-danger" style="width: 150px; height: 34px;float:right;" onclick="javascript:CloseSUWin('EditCarriage');">关闭</a></td>
                        </c:if>
						</tr>
					</div>
