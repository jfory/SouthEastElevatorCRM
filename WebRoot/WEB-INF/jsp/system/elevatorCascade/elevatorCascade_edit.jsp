	...
	<div class="wrapper wrapper-content">
		<div class="row">
			<div class="col-sm-12">
				...
				<%--用户ID--%>
				<form action="elevatorCascade/${msg }.do" name="elevatorCascadeForm" id="elevatorCascadeForm" method="post">
				...
				<div class="ibox float-e-margins">
							...
							<div class="col-lg-12">
								...
								<c:choose>
									<c:when test="${not empty pd.parentId}">
										<input type="text" value="${pd.parentName}" readonly id="departmentSelect" class="form-control" placeholder="请点击选择所属功能" onclick="showMenu();">
									</c:when>
									<c:otherwise>
										<input type="text" value="" readonly id="departmentSelect" class="form-control" placeholder="请点击选择所属功能" onclick="showMenu();">
									</c:otherwise>
								</c:choose>
							    </div>
								<div class="form-group form-inline" style="margin-top: 15px;">
					...
					<tr>
						...
						<c:if test="${msg eq 'addElevatorCascade'}">
							<td><a class="btn btn-danger" style="width: 150px; height: 34px;float:right;" onclick="javascript:CloseSUWin('AddElevatorCascade');">关闭</a></td>
						</c:if>
						<c:if test="${msg eq 'editElevatorCascade'}">
						<td><a class="btn btn-danger" style="width: 150px; height: 34px;float:right;" onclick="javascript:CloseSUWin('EditElevatorCascade');">关闭</a></td>
						</c:if>
					</tr>
				</div>
			</form>
