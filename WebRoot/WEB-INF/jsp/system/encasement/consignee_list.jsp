...
<body class="gray-bg">
	            ...
	            <div class="col-sm-12">
	                <div class="ibox float-e-margins">
	                    ...
	                    <div id="top",name="top"></div>
	                        <form role="form" class="form-inline" action="encasement/listConsignee.do" method="post" name="ConsigneeForm" id="ConsigneeForm">
													...
													<tr>
														...
														<td>
															...
															<div>
																...
																<c:if test="${QX.edit == 1 }">
																	<button class="btn btn-sm btn-primary btn-sm" title="电梯列表" type="button" onclick="listElevatorDetails('${var.consignee_id}','edit');">电梯列表</button>
    ...
    <script type="text/javascript">
		...
		//电梯列表
		function listElevatorDetails(consignee_id){
			$("#ListElevatorDetails").kendoWindow({
		        width: "1000px",
		        height: "800px",
		        title: "电梯列表",
		        actions: ["Close"],
		        content: '<%=basePath%>encasement/listElevatorDetails.do?consignee_id='+consignee_id,
		        modal : true,
				visible : false,
				resizable : true
		    }).data("kendoWindow").maximize().open();
			...
			swal({
	            ...
	            function (isConfirm) {
	                if (isConfirm) {
	                	$.ajax({
							type: "POST",
							url: '<%=basePath%>encasement/subShipping.do',
