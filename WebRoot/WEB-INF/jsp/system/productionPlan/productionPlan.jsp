...
<body class="gray-bg">
			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-content">
						...
						<form role="form" class="form-inline" action="productionPlan/productionOnePlan.do"
						...
						<div class="table-responsive">
														    ...
														    <c:if test="${QX.edit != 1 && QX.del != 1 }">
																<span class="label label-large label-grey arrowed-in-right arrowed-in"><i class="icon-lock" title="无权限">无权限</i></span>
																 ...
																 <button class="btn  btn-success btn-sm" title="查看计划" type="button" 
																  ...
																  <%-- <button class="btn  btn-warning btn-sm" title="添加特批电梯" type="button" 
																  onclick="addelevator('${var.pro_no}')">添加特批电梯</button> --%>
														</td>
													</tr>
												</c:forEach>
											</c:if>
							...
							<div class="col-lg-12"
								...
								<a class="btn btn-warning" title="导出到Excel" type="button" target="_blank" href="<%=basePath%>productionPlan/toExcel.do">导出</a>
  ...
  //启动流程
	...
	//导出到Excel
		function toExcel(){
			$.post("<%=basePath%>productionPlan/toExcel.do");
		}
		...
		function importExcel(e){
	    	...
	    	$.ajax({
	            url:"<%=basePath%>productionPlan/importExcel.do",
	            type:"POST",
	            data:data,
	            cache: false,
	            processData:false,
		...
		// 下载文件   e代表当前路径值 
		function downFile() {
			var url="uploadFiles/file/DataModel/Production/一排排产计划.xls";
