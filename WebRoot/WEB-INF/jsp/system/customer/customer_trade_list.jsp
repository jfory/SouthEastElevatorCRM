	                       ...
	                       <form role="form" class="form-inline" action="tradeType/listTradeType.do" method="post" name="TradeTypeForm" id="TradeTypeForm">
	                        ...
	                        <div class="table-responsive">
	                            <table class="table table-striped table-bordered table-hover">
	                                <thead>
	                                    <tr>
	                                        ...
	                                        <th style="width:10%;">行业编号</th>
	                                        <th style="width:10%;">行业名称</th>
	                                        <th style="width:20%;">行业描述</th>
	                                ...
	                                <!-- 开始循环 -->	
									<c:choose>
										<c:when test="${not empty tradeTypes}">
											<c:if test="${QX.cha == 1 }">
												<c:forEach items="${tradeTypes}" var="var" >
													<tr>
								...
								<div class="col-lg-12" style="padding-left:0px;padding-right:0px">
									...
									<a class="btn btn-warning btn-outline" title="导出到Excel" type="button" target="_blank" href="<%=basePath%>tradeType/toExcel.do">导出</a>
 ...
 <!--返回顶部开始-->
	...
	//导入Excel
		function importExcel(e){
        	...
        	$.ajax({
	            url:"<%=basePath%>tradeType/importExcel.do",
	            type:"POST",
	            data:data,
	            cache: false,
	            processData:false,
	...
	function add(){
		$("#EditTradeType").kendoWindow({
	        ...
	        title: "新增客户行业",
	        actions: ["Close"],
	        content: '<%=basePath%>tradeType/goAddTradeType.do',
	        modal : true,
			visible : false,
			resizable : true
	...
	// 下载文件   e代表当前路径值 
	function downFile() {
		var url="uploadFiles/file/DataModel/Customer/客户行业.xls";
