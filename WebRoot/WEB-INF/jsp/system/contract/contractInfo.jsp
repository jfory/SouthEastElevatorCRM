...
<body class="gray-bg" >
    ...
    <input type="hidden" name="type" id="type">  
      <div class="col-sm-12">
        <div class="form-inline">
            <select style="width:15%;margin-top:5px" class="form-control m-b" name="itemStatus" id="itemStatus" onchange="setByType()">
    ...
    function setByType(){
        ...
        $.post("<%=basePath%>contract/setByType.do?type="+type+"&itemStatus="+itemStatus,
            function(data){
