...
<body class="gray-bg">
    <div class="wrapper wrapper-content animated fadeInRight">
    	<div id="ChangeTheAgreement" class="animated fadeIn"></div><!-- 打开查看 -->
							...
							<div id="tab-2" class="tab-pane">
								<div class="ibox float-e-margins">
									<div class="ibox-content">
										...
										<form role="form" class="form-inline" action="contractModify/ContractAudit.do" method="post" name="leaveForm2" id="leaveForm2">
										...
										<div class="table-responsive">
											<table class="table table-striped table-bordered table-hover">
												...
												<tr>
													...
													<th style="text-align:center;">变更协议号</th>
													<th style="text-align:center;">次第</th>
														...
														<c:if test="${QX.cha == 1 }">
															<c:forEach items="${ContractList}" var="eo" varStatus="vs2">
																<tr>
																	...
																	<td style="text-align:center;">${eo.modify_number}</td>
																	<td style="text-align:center;">${eo.squence}</td>
							...
							<div id="tab-3" class="tab-pane">
								<div class="ibox float-e-margins">
									<div class="ibox-content">
										...
										<form role="form" class="form-inline" action="contractModify/listDoneOffer.do" method="post" name="leaveForm3" id="leaveForm3">
														...
														<c:if test="${QX.cha == 1 }">
															<c:forEach items="${ContractList}" var="e" varStatus="vs3">
																<tr>
																	...
																	<td style="text-align:center;">${e.modify_number}</td>
																	<td style="text-align:center;">${e.squence}</td>
	...
	<script type="text/javascript">
		...
		function search(id){
		 ...
		 function claimstra(task_id){
			 swal({
				 ...
				 if (isConfirm === true) {
					 var url = "<%=basePath%>contractModify/claim.do?task_id="+task_id+"&tm="+new Date().getTime();
	 ...
	 function goHandlestra(task_id,id){
		 $("#handleLeave").kendoWindow({
			 ...
			 title: "办理任务",
			 actions: ["Close"],
			 content: '<%=basePath%>contractModify/goHandStra.do?task_id='+task_id+'&id='+id,
			 modal : true,
			 visible : false,
			 resizable : true
