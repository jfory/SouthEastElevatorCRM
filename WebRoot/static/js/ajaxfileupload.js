jQuery.extend({
    ...
    createUploadForm: function (id, fileElementId, elements,data) {//id为当前系统时间字符串，fileElementId为页面<input type='file' />的id，data的值需要根据传入json的键来决定
        //create form    
        ...
        jQuery(oldElement).val(elements);
    ...
    ajaxFileUpload: function (s) {//这里s是个json对象，传入一些ajax的参数
        ...
        var form = jQuery.createUploadForm(id, s.fileElementId,s.elements, (typeof (s.data) == 'undefined' ? false : s.data)); //创建动态form
