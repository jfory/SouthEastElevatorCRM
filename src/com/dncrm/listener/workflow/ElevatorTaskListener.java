 ...
 **/
public class ElevatorTaskListener implements TaskListener
{
    ...
    private String getTaskType(String taskName){
    	String type = "";
    	if("GeneralElevatorTechnicalSupport".equals(taskName)){
    		type = "3";
    	}else if("HouseHoldElevatorTechnicalSupport".equals(taskName)){
    		type = "3";
    	}else if("SpecialElevatorTechnicalSupport".equals(taskName)){
    		type = "3";
    	}else if("Finance".equals(taskName)){
    		type = "3";
    	}
    	return type;
    }
